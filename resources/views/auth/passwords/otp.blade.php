            ...
            <form method="POST" action="{{ route('password.otgRequest') }}">
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <input id="forgotMobile" type="number" class="form-field usermobtxt {{ $errors->has('mobile') ? ' is-invalid' : '' }} " name="mobile" value="{{ old('mobile') }}" placeholder="Mobile Number" required="" autofocus="">
