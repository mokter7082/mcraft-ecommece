		...
		<section class="orderSuccess-panel">
			<div class="payment-top">
				<div class="p-container">
					...
					?>
					<h3>Your order number <strong> {{ date('ym', $timestamp) }}{{ $orderInfo->id }} </strong></h3>
					<p>Your order is completed now, please pay with <span class="color-green">{{ $orderInfo->payment_method }}</span></p>
				</div>
			</div>
