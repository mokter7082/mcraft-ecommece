...
<html lang="{{ app()->getLocale() }}">
  ...
  <body>
    ...
    <div class="navbar">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="{{ route('admin.dashboard') }}"><span>
            M CRAFT
          </span></a>
          <!-- start: Header Menu -->
        ...
        <div id="sidebar-left" class="span2">
          <div class="nav-collapse sidebar-nav">
            <ul class="nav nav-tabs nav-stacked main-menu">
              ...
              <li><a href="{{ route('admin.order', 'pending') }}"><i class="icon-list-alt"></i><span class="hidden-tablet"> Order </span></a></li>
    ...
    <footer>
      <p>
        <span style="text-align:left;float:left">&copy; 2018 <a href="http://www.mcraftbd.com/" alt="Bootstrap Themes">M Craft</a></span>
    ...
    <script>
     $(document).ready(function(){
      ...
      {
        $.getJSON("/admin/product/"+ $(this).val() +"/city", function(jsonData){
