if (function(t, e) {
        ...
        v.fn = v.prototype = {
            ...
            var t, e, n, i, o, s, r = arguments[0] || {},
                ...
                l = arguments.length,
                h = !1;
            for ("boolean" == typeof r && (h = r, r = arguments[a] || {}, a++), "object" == typeof r || v.isFunction(r) || (r = {}), a === l && (r = this, a--); a < l; a++)
                if (null != (t = arguments[a]))
                    for (e in t) n = r[e], i = t[e], r !== i && (h && i && (v.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1, s = n && Array.isArray(n) ? n : []) : s = n && v.isPlainObject(n) ? n : {}, r[e] = v.extend(h, s, i)) : void 0 !== i && (r[e] = i));
            return r
        }, v.extend({
            ...
            isPlainObject: function(t) {
                var e, n;
                return !(!t || "[object Object]" !== c.call(t) || (e = o(t)) && (n = u.call(e, "constructor") && e.constructor, "function" != typeof n || d.call(n) !== p))
            },
            ...
            camelCase: function(t) {
                return t.replace(w, "ms-").replace(_, b)
            },
            each: function(t, e) {
                var n, i = 0;
                if (x(t))
            ...
            makeArray: function(t, e) {
                var n = e || [];
                return null != t && (x(Object(t)) ? v.merge(n, "string" == typeof t ? [t] : t) : a.call(n, t)), n
            },
            ...
            proxy: function(t, e) {
                var n, i, o;
                if ("string" == typeof e && (n = t[e], e = t, t = n), v.isFunction(t)) return i = s.call(arguments, 2), o = function() {
        ...
        var T = function(t) {
            var e, n, i, o, s, r, a, l, h, c, u, d, p, f, g, m, v, y, w, _ = "sizzle" + 1 * new Date,
                b = t.document,
                x = 0,
                T = 0,
                C = rt(),
            ...
            try {
                D.apply(k = L.call(b.childNodes), b.childNodes), k[b.childNodes.length].nodeType
            } catch (t) {
                D = {
                ...
                if (!o && ((e ? e.ownerDocument || e : b) !== p && d(e), e = e || p, g)) {
                    if (11 !== x && (u = K.exec(t)))
                        if (s = u[1]) {
                            ...
                            } else if (y && (h = y.getElementById(s)) && w(e, h) && h.id === s) return i.push(h), i
                        } else {
                        ...
                        if (1 !== x) y = e, v = t;
                            ...
                            for ((c = e.getAttribute("id")) ? c = c.replace(et, nt) : e.setAttribute("id", c = _), a = (f = r(t)).length; a--;) f[a] = "#" + c + " " + vt(f[a]);
            ...
            n = st.support = {}, s = st.isXML = function(t) {
                var e = t && (t.ownerDocument || t).documentElement;
                return !!e && "HTML" !== e.nodeName
            }, d = st.setDocument = function(t) {
                var e, o, r = t ? t.ownerDocument || t : b;
                return r !== p && 9 === r.nodeType && r.documentElement ? (f = (p = r).documentElement, g = !s(p), b !== p && (o = p.defaultView) && o.top !== o && (o.addEventListener ? o.addEventListener("unload", it, !1) : o.attachEvent && o.attachEvent("onunload", it)), n.attributes = lt(function(t) {
                    return t.className = "i", !t.getAttribute("className")
                }), n.getElementsByTagName = lt(function(t) {
                    return t.appendChild(p.createComment("")), !t.getElementsByTagName("*").length
                }), n.getElementsByClassName = X.test(p.getElementsByClassName), n.getById = lt(function(t) {
                ...
                }, v = [], m = [], (n.qsa = X.test(p.querySelectorAll)) && (lt(function(t) {
                ...
                })), (n.matchesSelector = X.test(y = f.matches || f.webkitMatchesSelector || f.mozMatchesSelector || f.oMatchesSelector || f.msMatchesSelector)) && lt(function(t) {
                    n.disconnectedMatch = y.call(t, "*"), y.call(t, "[s!='']:x"), v.push("!=", $)
                }), m = m.length && new RegExp(m.join("|")), v = v.length && new RegExp(v.join("|")), e = X.test(f.compareDocumentPosition), w = e || X.test(f.contains) ? function(t, e) {
                    ...
                    return i || (1 & (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !n.sortDetached && e.compareDocumentPosition(t) === i ? t === p || t.ownerDocument === b && w(b, t) ? -1 : e === p || e.ownerDocument === b && w(b, e) ? 1 : c ? I(c, t) - I(c, e) : 0 : 4 & i ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return u = !0, 0;
                    var n, i = 0,
                        o = t.parentNode,
                        ...
                        r = [t],
                        a = [e];
                    if (!o || !s) return t === p ? -1 : e === p ? 1 : o ? -1 : s ? 1 : c ? I(c, t) - I(c, e) : 0;
                    if (o === s) return ct(t, e);
                    for (n = t; n = n.parentNode;) r.unshift(n);
                    for (n = e; n = n.parentNode;) a.unshift(n);
                    for (; r[i] === a[i];) i++;
                    return i ? ct(r[i], a[i]) : r[i] === b ? -1 : a[i] === b ? 1 : 0
                }, p) : p
            }, st.matches = function(t, e) {
                return st(t, null, null, e)
            }, st.matchesSelector = function(t, e) {
                if ((t.ownerDocument || t) !== p && d(t), e = e.replace(q, "='$1']"), n.matchesSelector && g && !E[e + " "] && (!v || !v.test(e)) && (!m || !m.test(e))) try {
                    var i = y.call(t, e);
                ...
                var o = i.attrHandle[e.toLowerCase()],
                    s = o && W.call(i.attrHandle, e.toLowerCase()) ? o(t, e, !g) : void 0;
                ...
                filter: {
                    ...
                    PSEUDO: function(t, e) {
                        ...
                        return o[_] ? o(e) : o.length > 1 ? (n = [t, t, "", e], i.setFilters.hasOwnProperty(t.toLowerCase()) ? at(function(t, n) {
                            for (var i, s = o(t, e), r = s.length; r--;) i = I(t, s[r]), t[i] = !(n[i] = s[r])
                        }) : function(t) {
                            return o(t, 0, n)
                        }) : o
                    }
                ...
                pseudos: {
                    ...
                    lang: at(function(t) {
                        return Z.test(t || "") || st.error("unsupported lang: " + t), t = t.replace(J, tt).toLowerCase(),
                            function(e) {
                                var n;
                                do {
            ...
            function yt(t, e, n) {
                ...
                return e.first ? function(e, n, o) {
                    ...
                    if (l) {
                        ...
                        for (; e = e[i];)
                            if (1 === e.nodeType || r)
                                if (u = e[_] || (e[_] = {}), c = u[e.uniqueID] || (u[e.uniqueID] = {}), o && o === e.nodeName.toLowerCase()) e = e[i] || e;
                                else {
            ...
            function _t(t, e, n, i, o) {
                for (var s, r = [], a = 0, l = t.length, h = null != e; a < l; a++)(s = t[a]) && (n && !n(s, i, o) || (r.push(s), h && e.push(a)));
                return r
            }

            function bt(t, e, n, i, o, s) {
                return i && !i[_] && (i = bt(i)), o && !o[_] && (o = bt(o, s)), at(function(s, r, a, l) {
                    var h, c, u, d = [],
                        p = [],
                        f = r.length,
                        g = s || function(t, e, n) {
                        ...
                        v = n ? o || (s ? t : f || i) ? [] : r : m;
                    if (n && n(m, v, a, l), i)
                        for (h = _t(v, p), i(h, [], a, l), c = h.length; c--;)(u = h[c]) && (v[p[c]] = !(m[p[c]] = u));
                    if (s) {
                        if (o || t) {
                            if (o) {
                            ...
                            for (c = v.length; c--;)(u = v[c]) && (h = o ? I(s, u) : d[c]) > -1 && (s[h] = !(r[h] = u))
                        }
                    } else v = _t(v === r ? v.splice(f, v.length) : v), o ? o(null, r, v, l) : D.apply(r, v)
                })
            }

            function xt(t) {
                for (var e, n, o, s = t.length, r = i.relative[t[0].type], a = r || i.relative[" "], l = r ? 1 : 0, c = yt(function(t) {
                        return t === e
                    }, a, !0), u = yt(function(t) {
                        return I(e, t) > -1
                    ...
                    if (n = i.relative[t[l].type]) d = [yt(wt(d), n)];
                    else {
                        if ((n = i.filter[t[l].type].apply(null, t[l].matches))[_]) {
                            ...
                            return bt(l > 1 && wt(d), l > 1 && vt(t.slice(0, l - 1).concat({
                                value: " " === t[l - 2].type ? "*" : ""
                            })).replace(M, "$1"), n, l < o && xt(t.slice(l, o)), o < s && xt(t = t.slice(o)), o < s && vt(t))
                        }
                        d.push(n)
                    } return wt(d)
            }
            return mt.prototype = i.filters = i.pseudos, i.setFilters = new mt, r = st.tokenize = function(t, e) {
                ...
                for (a = t, l = [], h = i.preFilter; a;) {
                    n && !(o = F.exec(a)) || (o && (a = a.slice(o[0].length) || a), l.push(s = [])), n = !1, (o = B.exec(a)) && (n = o.shift(), s.push({
                        value: n,
                        type: o[0].replace(M, " ")
                    }), a = a.slice(n.length));
                    for (r in i.filter) !(o = Q[r].exec(a)) || h[r] && !(o = h[r](o)) || (n = o.shift(), s.push({
                        value: n,
                        type: r,
                        matches: o
                    }), a = a.slice(n.length));
                ...
                var n, o, s, a, l, c, u = [],
                    ...
                    m = E[t + " "];
                if (!m) {
                    for (e || (e = r(t)), n = e.length; n--;) m = xt(e[n]), m[_] ? u.push(m) : f.push(m);
                    (m = E(t, (o = f, a = (s = u).length > 0, l = o.length > 0, c = function(t, e, n, r, c) {
                        var u, f, m, v = 0,
                            y = "0",
                            w = t && [],
                            _ = [],
                            ...
                            z = T.length;
                        for (c && (h = e === p || e || c); y !== z && null != (u = T[y]); y++) {
                            if (l && u) {
                                for (f = 0, e || u.ownerDocument === p || (d(u), n = !g); m = o[f++];)
                                    if (m(u, e || p, n)) {
                                        r.push(u);
                                        break
                                    } c && (x = C)
                            }
                            a && ((u = !m && u) && v--, t && w.push(u))
                        }
                        if (v += y, a && y !== v) {
                            for (f = 0; m = s[f++];) m(w, _, e, n);
                            if (t) {
                                if (v > 0)
                                    for (; y--;) w[y] || _[y] || (_[y] = A.call(r));
                                _ = _t(_)
                            }
                            D.apply(r, _), c && !t && _.length > 0 && v + s.length > 1 && st.uniqueSort(r)
                        }
                        return c && (x = C, h = b), w
                    }, a ? at(c) : c))).selector = t
                }
                ...
                if (n = n || [], 1 === p.length) {
                    if ((l = p[0] = p[0].slice(0)).length > 2 && "ID" === (h = l[0]).type && 9 === e.nodeType && g && i.relative[l[1].type]) {
                        if (!(e = (i.find.ID(h.matches[0].replace(J, tt), e) || [])[0])) return n;
                        d && (e = e.parentNode), t = t.slice(l.shift().value.length)
                    }
                    for (s = Q.needsContext.test(t) ? 0 : l.length; s-- && (h = l[s], !i.relative[c = h.type]);)
                        if ((u = i.find[c]) && (o = u(h.matches[0].replace(J, tt), G.test(l[0].type) && gt(e.parentNode) || e))) {
                            if (l.splice(s, 1), !(t = o.length && vt(l))) return D.apply(n, o), n;
                            break
                        }
                }
                return (d || a(t, p))(o, e, !g, n, !e || G.test(t) && gt(e.parentNode) || e), n
        ...
        function A(t, e, n) {
            ...
            }) : k.test(e) ? v.filter(e, t, n) : (e = v.filter(e, t), v.grep(t, function(t) {
        ...
        (v.fn.init = function(t, e, n) {
            ...
            if (n = n || O, "string" == typeof t) {
                if (!(o = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : D.exec(t)) || !o[1] && e) return !e || e.jquery ? (e || n).find(t) : this.constructor(e).find(t);
                if (o[1]) {
                    if (e = e instanceof v ? e[0] : e, v.merge(this, v.parseHTML(o[1], e && e.nodeType ? e.ownerDocument || e : i, !0)), W.test(o[1]) && v.isPlainObject(e))
        ...
        v.fn.extend({
            ...
            v.fn[t] = function(n, i) {
                ...
                return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = v.filter(i, o)), this.length > 1 && (I[t] || v.uniqueSort(o), L.test(t) && o.reverse()), this.pushStack(o)
            }
        });
        var N = /[^\x20\t\r\n\f]+/g;
        ...
        v.Callbacks = function(t) {
            var e, n;
            t = "string" == typeof t ? (e = t, n = {}, v.each(e.match(N) || [], function(t, e) {
                n[e] = !0
            }), n) : v.extend({}, t);
            var i, o, s, r, a = [],
                l = [],
                h = -1,
                c = function() {
                    for (r = r || t.once, s = i = !0; l.length; h = -1)
                        for (o = l.shift(); ++h < a.length;) !1 === a[h].apply(o[0], o[1]) && t.stopOnFalse && (h = a.length, o = !1);
                    t.memory || (o = !1), i = !1, r && (a = o ? [] : "")
                },
                u = {
                    add: function() {
                        return a && (o && !i && (h = a.length - 1, l.push(o)), function e(n) {
                            v.each(n, function(n, i) {
                                v.isFunction(i) ? t.unique && u.has(i) || a.push(i) : i && i.length && "string" !== v.type(i) && e(i)
                            })
                    ...
                    remove: function() {
                        return v.each(arguments, function(t, e) {
                            for (var n;
                                (n = v.inArray(e, a, n)) > -1;) a.splice(n, 1), n <= h && h--
                        }), this
                    },
                    has: function(t) {
                    ...
                    fireWith: function(t, e) {
                        return r || (e = [t, (e = e || []).slice ? e.slice() : e], l.push(e), i || c()), this
                    },
                    fire: function() {
                    ...
                    o = {
                        ...
                        then: function(e, i, o) {
                                    ...
                                    var a = this,
                                        ...
                                        h = function() {
                                            ...
                                            if (!(e < s)) {
                                                ...
                                                h = t && ("object" == typeof t || "function" == typeof t) && t.then, v.isFunction(h) ? o ? h.call(t, r(s, n, P, o), r(s, n, j, o)) : (s++, h.call(t, r(s, n, P, o), r(s, n, j, o), r(s, n, P, n.notifyWith))) : (i !== P && (a = void 0, l = [t]), (o || n.resolveWith)(a, l))
                                            }
                                        },
                                        c = o ? h : function() {
                                            try {
                                                ...
                                                v.Deferred.exceptionHook && v.Deferred.exceptionHook(t, c.stackTrace), e + 1 >= s && (i !== j && (a = void 0, l = [t]), n.rejectWith(a, l))
                                            }
                                        };
                            ...
                            return v.Deferred(function(t) {
                                n[0][3].add(r(0, t, v.isFunction(o) ? o : P, t.notifyWith)), n[1][3].add(r(0, t, v.isFunction(e) ? e : P)), n[2][3].add(r(0, t, v.isFunction(i) ? i : j))
                            }).promise()
                        },
                        promise: function(t) {
            ...
            when: function(t) {
                ...
                if (e <= 1 && ($(t, r.done(a(n)).resolve, r.reject, !e), "pending" === r.state() || v.isFunction(o[n] && o[n].then))) return r.then();
        ...
        function F() {
            i.removeEventListener("DOMContentLoaded", F), t.removeEventListener("load", F), v.ready()
        }
        v.fn.ready = function(t) {
            ...
            readyWait: 1,
            ready: function(t) {
                (!0 === t ? --v.readyWait : v.isReady) || (v.isReady = !0, !0 !== t && --v.readyWait > 0 || M.resolveWith(i, [v]))
            }
        }), v.ready.then = M.then, "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? t.setTimeout(v.ready) : (i.addEventListener("DOMContentLoaded", F), t.addEventListener("load", F));
        var B = function(t, e, n, i, o, s, r) {
                ...
                if ("object" === v.type(n)) {
                    o = !0;
                    for (a in n) B(t, e, a, n[a], !0, s, r)
                } else if (void 0 !== i && (o = !0, v.isFunction(i) || (r = !0), h && (r ? (e.call(t, i), e = null) : (h = e, e = function(t, e, n) {
                        return h.call(v(t), n)
                    })), e))
        ...
        U.uid = 1, U.prototype = {
            ...
            remove: function(t, e) {
                ...
                if (void 0 !== i) {
                    if (void 0 !== e) {
                        Array.isArray(e) ? e = e.map(v.camelCase) : e = (e = v.camelCase(e)) in i ? [e] : e.match(N) || [], n = e.length;
                        for (; n--;) delete i[e[n]]
        ...
        function X(t, e, n) {
            ...
            if (void 0 === n && 1 === t.nodeType)
                if (i = "data-" + e.replace(V, "-$&").toLowerCase(), n = t.getAttribute(i), "string" == typeof n) {
                    try {
        ...
        v.extend({
            ...
            data: function(t, e) {
                var n, i, o, s = this[0],
                    r = s && s.attributes;
                if (void 0 === t) {
                    if (this.length && (o = Q.get(s), 1 === s.nodeType && !Z.get(s, "hasDataAttrs"))) {
                        for (n = r.length; n--;) r[n] && (i = r[n].name, 0 === i.indexOf("data-") && (i = v.camelCase(i.slice(5)), X(s, i, o[i])));
                ...
                return "object" == typeof t ? this.each(function() {
                    ...
                    var n;
                    if (s && void 0 === e) {
                        if (void 0 !== (n = Q.get(s, t))) return n;
                        if (void 0 !== (n = X(s, t))) return n
            ...
            queue: function(t, e, n) {
                var i;
                if (t) return e = (e || "fx") + "queue", i = Z.get(t, e), n && (!i || Array.isArray(n) ? i = Z.access(t, e, v.makeArray(n)) : i.push(n)), i || []
            },
            ...
            promise: function(t, e) {
                ...
                for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; r--;) n = Z.get(s[r], t + "queueHooks"), n && n.empty && (i++, n.empty.add(a));
        ...
        function nt(t, e, n, i) {
            var o, s = 1,
                ...
                l = a(),
                h = n && n[3] || (v.cssNumber[e] ? "" : "px"),
                c = (v.cssNumber[e] || "px" !== h && +l) && G.exec(v.css(t, e));
            if (c && c[3] !== h) {
                h = h || c[3], n = n || [], c = +l || 1;
                do {
                    s = s || ".5", c /= s, v.style(t, e, c + h)
                } while (s !== (s = a() / l) && 1 !== s && --r)
            }
            return n && (c = +c || +l || 0, o = n[1] ? c + (n[1] + 1) * n[2] : +n[2], i && (i.unit = h, i.start = c, i.end = o)), o
        }
        var it = {};

        function ot(t, e) {
            for (var n, i, o = [], s = 0, r = t.length; s < r; s++) i = t[s], i.style && (n = i.style.display, e ? ("none" === n && (o[s] = Z.get(i, "display") || null, o[s] || (i.style.display = "")), "" === i.style.display && tt(i) && (o[s] = (a = i, l = void 0, h = void 0, void 0, u = void 0, h = a.ownerDocument, c = a.nodeName, u = it[c], u || (l = h.body.appendChild(h.createElement(c)), u = v.css(l, "display"), l.parentNode.removeChild(l), "none" === u && (u = "block"), it[c] = u, u)))) : "none" !== n && (o[s] = "none", Z.set(i, "display", n)));
            var a, l, h, c, u;
        ...
        function ft(t, e, n, i, o) {
            for (var s, r, a, l, h, c, u = e.createDocumentFragment(), d = [], p = 0, f = t.length; p < f; p++)
                if (s = t[p], s || 0 === s)
                    if ("object" === v.type(s)) v.merge(d, s.nodeType ? [s] : s);
                    else if (pt.test(s)) {
                for (r = r || u.appendChild(e.createElement("div")), a = (rt.exec(s) || ["", ""])[1].toLowerCase(), l = lt[a] || lt._default, r.innerHTML = l[1] + v.htmlPrefilter(s) + l[2], c = l[0]; c--;) r = r.lastChild;
                v.merge(d, r.childNodes), (r = u.firstChild).textContent = ""
            } else d.push(e.createTextNode(s));
            for (u.textContent = "", p = 0; s = d[p++];)
                if (i && v.inArray(s, i) > -1) o && o.push(s);
                else if (h = v.contains(s.ownerDocument, s), r = ht(u.appendChild(s), "script"), h && ct(r), n)
                for (c = 0; s = r[c++];) at.test(s.type || "") && n.push(s);
            return u
        }
        ut = i.createDocumentFragment().appendChild(i.createElement("div")), (dt = i.createElement("input")).setAttribute("type", "radio"), dt.setAttribute("checked", "checked"), dt.setAttribute("name", "t"), ut.appendChild(dt), f.checkClone = ut.cloneNode(!0).cloneNode(!0).lastChild.checked, ut.innerHTML = "<textarea>x</textarea>", f.noCloneChecked = !!ut.cloneNode(!0).lastChild.defaultValue;
        ...
        v.event = {
            ...
            add: function(t, e, n, i, o) {
                var s, r, a, l, h, c, u, d, p, f, g, m = Z.get(t);
                if (m)
                    for (n.handler && (n = (s = n).handler, o = s.selector), o && v.find.matchesSelector(gt, o), n.guid || (n.guid = v.guid++), (l = m.events) || (l = m.events = {}), (r = m.handle) || (r = m.handle = function(e) {
                            return void 0 !== v && v.event.triggered !== e.type ? v.event.dispatch.apply(t, arguments) : void 0
                        }), h = (e = (e || "").match(N) || [""]).length; h--;) a = yt.exec(e[h]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p && (u = v.event.special[p] || {}, p = (o ? u.delegateType : u.bindType) || p, u = v.event.special[p] || {}, c = v.extend({
                        type: p,
                        origType: g,
                        data: i,
                        handler: n,
                        ...
                        namespace: f.join(".")
                    }, s), (d = l[p]) || (d = l[p] = [], d.delegateCount = 0, u.setup && !1 !== u.setup.call(t, i, f, r) || t.addEventListener && t.addEventListener(p, r)), u.add && (u.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), o ? d.splice(d.delegateCount++, 0, c) : d.push(c), v.event.global[p] = !0)
            },
            remove: function(t, e, n, i, o) {
                var s, r, a, l, h, c, u, d, p, f, g, m = Z.hasData(t) && Z.get(t);
                if (m && (l = m.events)) {
                    for (h = (e = (e || "").match(N) || [""]).length; h--;)
                        if (a = yt.exec(e[h]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p) {
                            for (u = v.event.special[p] || {}, d = l[p = (i ? u.delegateType : u.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = s = d.length; s--;) c = d[s], !o && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (d.splice(s, 1), c.selector && d.delegateCount--, u.remove && u.remove.call(t, c));
                            r && !d.length && (u.teardown && !1 !== u.teardown.call(t, f, m.handle) || v.removeEvent(t, p, m.handle), delete l[p])
                        } else
                            for (p in l) v.event.remove(t, p + e[h], n, i, !0);
                    v.isEmptyObject(l) && Z.remove(t, "handle events")
                }
            },
            dispatch: function(t) {
                var e, n, i, o, s, r, a = v.event.fix(t),
                ...
                if (a.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
                    for (r = v.event.handlers.call(this, a, h), e = 0;
                        ...
                        for (a.currentTarget = o.elem, n = 0;
                            (s = o.handlers[n++]) && !a.isImmediatePropagationStopped();) a.rnamespace && !a.rnamespace.test(s.namespace) || (a.handleObj = s, a.data = s.data, i = ((v.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, l), void 0 !== i && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
                ...
                if (l && h.nodeType && !("click" === t.type && t.button >= 1))
                    for (; h !== this; h = h.parentNode || this)
                        if (1 === h.nodeType && ("click" !== t.type || !0 !== h.disabled)) {
                            for (s = [], r = {}, n = 0; n < l; n++) i = e[n], o = i.selector + " ", void 0 === r[o] && (r[o] = i.needsContext ? v(o, this).index(h) > -1 : v.find(o, this, null, [h]).length), r[o] && s.push(i);
                            s.length && a.push({
                                elem: h,
                                handlers: s
                            })
            ...
            return this instanceof v.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? wt : _t, this.target = t.target && 3 === t.target.nodeType ? t.target.parentNode : t.target, this.currentTarget = t.currentTarget, this.relatedTarget = t.relatedTarget) : this.type = t, e && v.extend(this, e), this.timeStamp = t && t.timeStamp || v.now(), void(this[v.expando] = !0)) : new v.Event(t, e)
        }, v.Event.prototype = {
            constructor: v.Event,
        ...
        function Ot(t, e) {
            var n, i, o, s, r, a, l, h;
            if (1 === e.nodeType) {
                if (Z.hasData(t) && (s = Z.access(t), r = Z.set(e, s), h = s.events)) {
                    delete r.handle, r.events = {};
                    for (o in h)
                        for (n = 0, i = h[o].length; n < i; n++) v.event.add(e, o, h[o][n])
                }
        ...
        function Dt(t, e, n, i) {
            ...
            var o, s, a, l, h, c, u = 0,
                ...
                m = e[0],
                y = v.isFunction(m);
            if (y || d > 1 && "string" == typeof m && !f.checkClone && zt.test(m)) return t.each(function(o) {
                var s = t.eq(o);
                y && (e[0] = m.call(this, o, s.html())), Dt(s, e, n, i)
            });
            if (d && (s = (o = ft(e, t[0].ownerDocument, !1, t, i)).firstChild, 1 === o.childNodes.length && (o = s), s || i)) {
                for (l = (a = v.map(ht(o, "script"), kt)).length; u < d; u++) h = o, u !== p && (h = v.clone(h, !0, !0), l && v.merge(a, ht(h, "script"))), n.call(t[u], h, u);
                if (l)
                    for (c = a[a.length - 1].ownerDocument, v.map(a, At), u = 0; u < l; u++) h = a[u], at.test(h.type || "") && !Z.access(h, "globalEval") && v.contains(c, h) && (h.src ? v._evalUrl && v._evalUrl(h.src) : g(h.textContent.replace(St, ""), c))
            }
            return t
        }

        function Lt(t, e, n) {
            for (var i, o = e ? v.filter(e, t) : t, s = 0; null != (i = o[s]); s++) n || 1 !== i.nodeType || v.cleanData(ht(i)), i.parentNode && (n && v.contains(i.ownerDocument, i) && ct(ht(i, "script")), i.parentNode.removeChild(i));
            return t
        }
        v.extend({
            ...
            clone: function(t, e, n) {
                var i, o, s, r, a, l, h, c = t.cloneNode(!0),
                    u = v.contains(t.ownerDocument, t);
                if (!(f.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || v.isXMLDoc(t)))
                    for (r = ht(c), s = ht(t), i = 0, o = s.length; i < o; i++) a = s[i], l = r[i], void 0, h = l.nodeName.toLowerCase(), "input" === h && st.test(a.type) ? l.checked = a.checked : "input" !== h && "textarea" !== h || (l.defaultValue = a.defaultValue);
                if (e)
                    if (n)
                        for (s = s || ht(t), r = r || ht(c), i = 0, o = s.length; i < o; i++) Ot(s[i], r[i]);
                    else Ot(t, c);
                return (r = ht(c, "script")).length > 0 && ct(r, !u && ht(t, "script")), c
            },
            ...
            html: function(t) {
                return B(this, function(t) {
                    ...
                    if ("string" == typeof t && !Ct.test(t) && !lt[(rt.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = v.htmlPrefilter(t);
                        try {
                            for (; n < i; n++) e = this[n] || {}, 1 === e.nodeType && (v.cleanData(ht(e, !1)), e.innerHTML = t);
                            e = 0
                        } catch (t) {}
                    }
            ...
            replaceWith: function() {
                ...
                return Dt(this, arguments, function(e) {
                    ...
                    v.inArray(this, t) < 0 && (v.cleanData(ht(this)), n && n.replaceChild(e, this))
                }, t)
            }
        }), v.each({
            appendTo: "append",
        ...
        function Pt(t, e, n) {
            ...
            return (n = n || Nt(t)) && ("" !== (r = n.getPropertyValue(e) || n[e]) || v.contains(t.ownerDocument, t) || (r = v.style(t, e)), !f.pixelMarginRight() && Ht.test(r) && It.test(e) && (i = a.width, o = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = r, r = n.width, a.width = i, a.minWidth = o, a.maxWidth = s)), void 0 !== r ? r + "" : r
        }
        ...
        function Qt(t, e, n, i, o) {
            var s, r = 0;
            for (s = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; s < 4; s += 2) "margin" === n && (r += v.css(t, n + J[s], !0, o)), i ? ("content" === n && (r -= v.css(t, "padding" + J[s], !0, o)), "margin" !== n && (r -= v.css(t, "border" + J[s] + "Width", !0, o))) : (r += v.css(t, "padding" + J[s], !0, o), "padding" !== n && (r += v.css(t, "border" + J[s] + "Width", !0, o)));
            return r
        }
        ...
        function Yt(t, e, n) {
            ...
            return Ht.test(s) ? s : (i = r && (f.boxSizingReliable() || s === t.style[e]), "auto" === s && (s = t["offset" + e[0].toUpperCase() + e.slice(1)]), (s = parseFloat(s) || 0) + Qt(t, e, n || (r ? "border" : "content"), i, o) + "px")
        }
        ...
        v.extend({
            ...
            style: function(t, e, n, i) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var o, s, r, a = v.camelCase(e),
                        l = Rt.test(e),
                        h = t.style;
                    return l || (e = Ut(a)), r = v.cssHooks[e] || v.cssHooks[a], void 0 === n ? r && "get" in r && void 0 !== (o = r.get(t, !1, i)) ? o : h[e] : ("string" === (s = typeof n) && (o = G.exec(n)) && o[1] && (n = nt(t, e, o), s = "number"), void(null != n && n == n && ("number" === s && (n += o && o[3] || (v.cssNumber[a] ? "" : "px")), f.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (h[e] = "inherit"), r && "set" in r && void 0 === (n = r.set(t, n, i)) || (l ? h.setProperty(e, n) : h[e] = n))))
                }
            },
            css: function(t, e, n, i) {
                var o, s, r, a = v.camelCase(e);
                return Rt.test(e) || (e = Ut(a)), (r = v.cssHooks[e] || v.cssHooks[a]) && "get" in r && (o = r.get(t, !0, n)), void 0 === o && (o = Pt(t, e, i)), "normal" === o && e in Ft && (o = Ft[e]), "" === n || n ? (s = parseFloat(o), !0 === n || isFinite(s) ? s || 0 : o) : o
            }
        }), v.each(["height", "width"], function(t, e) {
            v.cssHooks[e] = {
                get: function(t, n, i) {
                    if (n) return !$t.test(v.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Yt(t, e, i) : et(t, Mt, function() {
                        return Yt(t, e, i)
                    })
                },
                set: function(t, n, i) {
                    var o, s = i && Nt(t),
                        r = i && Qt(t, e, i, "border-box" === v.css(t, "boxSizing", !1, s), s);
                    return r && (o = G.exec(n)) && "px" !== (o[3] || "px") && (t.style[e] = n, n = v.css(t, e)), Zt(0, n, r)
                }
            }
        }), v.cssHooks.marginLeft = jt(f.reliableMarginLeft, function(t, e) {
            ...
            }, It.test(t) || (v.cssHooks[t + e].set = Zt)
        }), v.fn.extend({
            css: function(t, e) {
                return B(this, function(t, e, n) {
                    var i, o, s = {},
                        r = 0;
                    if (Array.isArray(e)) {
                        for (i = Nt(t), o = e.length; r < o; r++) s[e[r]] = v.css(t, e[r], !1, i);
                        return s
                    }
            ...
            run: function(t) {
                ...
                return this.options.duration ? this.pos = e = v.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : Vt.propHooks._default.set(this), this
            }
        ...
        var Xt, Kt, Gt, Jt, te = /^(?:toggle|show|hide)$/,
            ee = /queueHooks$/;

        function ne() {
            Kt && (!1 === i.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(ne) : t.setTimeout(ne, v.fx.interval), v.fx.tick())
        }
        ...
        function oe(t, e) {
            ...
            for (e = e ? 1 : 0; i < 4; i += 2 - e) n = J[i], o["margin" + n] = o["padding" + n] = t;
        ...
        function re(t, e, n) {
            var i, o, s = 0,
                ...
                l = function() {
                    if (o) return !1;
                    for (var e = Xt || ie(), n = Math.max(0, h.startTime + h.duration - e), i = 1 - (n / h.duration || 0), s = 0, r = h.tweens.length; s < r; s++) h.tweens[s].run(i);
                    return a.notifyWith(t, [h, i, n]), i < 1 && r ? n : (r || a.notifyWith(t, [h, 1, 0]), a.resolveWith(t, [h]), !1)
                },
                h = a.promise({
                    elem: t,
                    props: v.extend({}, e),
                    ...
                    createTween: function(e, n) {
                        var i = v.Tween(t, h.opts, e, n, h.opts.specialEasing[e] || h.opts.easing);
                    ...
                    stop: function(e) {
                        ...
                        if (o) return this;
                        for (o = !0; n < i; n++) h.tweens[n].run(1);
            ...
            for (function(t, e) {
                    var n, i, o, s, r;
                    for (n in t)
                        if (i = v.camelCase(n), o = e[i], s = t[n], Array.isArray(s) && (o = s[1], s = t[n] = s[0]), n !== i && (t[i] = s, delete t[n]), r = v.cssHooks[i], r && "expand" in r) {
                            s = r.expand(s), delete t[i];
                            for (n in s) n in t || (t[n] = s[n], e[n] = o)
                        } else e[i] = o
                }(c, h.opts.specialEasing); s < r; s++)
                if (i = re.prefilters[s].call(h, t, c, h.opts)) return v.isFunction(i.stop) && (v._queueHooks(h.elem, h.opts.queue).stop = v.proxy(i.stop, i)), i;
            return v.map(c, se, h), v.isFunction(h.opts.start) && h.opts.start.call(t, h), h.progress(h.opts.progress).done(h.opts.done, h.opts.complete).fail(h.opts.fail).always(h.opts.always), v.fx.timer(v.extend(l, {
                elem: t,
                anim: h,
                queue: h.opts.queue
            })), h
        ...
        v.Animation = v.extend(re, {
            ...
            prefilters: [function(t, e, n) {
                var i, o, s, r, a, l, h, c, u = "width" in e || "height" in e,
                    d = this,
                    p = {},
                    f = t.style,
                    g = t.nodeType && tt(t),
                    m = Z.get(t, "fxshow");
                n.queue || (null == (r = v._queueHooks(t, "fx")).unqueued && (r.unqueued = 0, a = r.empty.fire, r.empty.fire = function() {
                    r.unqueued || a()
                ...
                for (i in e)
                    ...
                    u && 1 === t.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], null == (h = m && m.display) && (h = Z.get(t, "display")), "none" === (c = v.css(t, "display")) && (h ? c = h : (ot([t], !0), h = t.style.display || h, c = v.css(t, "display"), ot([t]))), ("inline" === c || "inline-block" === c && null != h) && "none" === v.css(t, "float") && (l || (d.done(function() {
                        f.display = h
                    }), null == h && (c = f.display, h = "none" === c ? "" : c)), f.display = "inline-block")), n.overflow && (f.overflow = "hidden", d.always(function() {
                        f.overflow = n.overflow[0], f.overflowX = n.overflow[1], f.overflowY = n.overflow[2]
                    })), l = !1;
                    for (i in p) l || (m ? "hidden" in m && (g = m.hidden) : m = Z.access(t, "fxshow", {
                        display: h
                    }), s && (m.hidden = !g), g && ot([t], !0), d.done(function() {
                        g || ot([t]), Z.remove(t, "fxshow");
                        for (i in p) v.style(t, i, p[i])
            ...
            var t, e = 0,
                n = v.timers;
            for (Xt = v.now(); e < n.length; e++) t = n[e], t() || n[e] !== t || n.splice(e--, 1);
        ...
        }, Gt = i.createElement("input"), Jt = i.createElement("select").appendChild(i.createElement("option")), Gt.type = "checkbox", f.checkOn = "" !== Gt.value, f.optSelected = Jt.selected, (Gt = i.createElement("input")).value = "t", Gt.type = "radio", f.radioValue = "t" === Gt.value;
        var ae, le = v.expr.attrHandle;
        v.fn.extend({
            attr: function(t, e) {
            ...
            attr: function(t, e, n) {
                ...
                if (3 !== s && 8 !== s && 2 !== s) return void 0 === t.getAttribute ? v.prop(t, e, n) : (1 === s && v.isXMLDoc(t) || (o = v.attrHooks[e.toLowerCase()] || (v.expr.match.bool.test(e) ? ae : void 0)), void 0 !== n ? null === n ? void v.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : o && "get" in o && null !== (i = o.get(t, e)) ? i : (i = v.find.attr(t, e), null == i ? void 0 : i))
            },
            attrHooks: {
                type: {
                    set: function(t, e) {
        ...
        v.fn.extend({
            ...
            prop: function(t, e, n) {
                var i, o, s = t.nodeType;
                if (3 !== s && 8 !== s && 2 !== s) return 1 === s && v.isXMLDoc(t) || (e = v.propFix[e] || e, o = v.propHooks[e]), void 0 !== n ? o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : t[e] = n : o && "get" in o && null !== (i = o.get(t, e)) ? i : t[e]
            },
            propHooks: {
                tabIndex: {
                    get: function(t) {
            ...
            toggleClass: function(t, e) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : v.isFunction(t) ? this.each(function(n) {
                    v(this).toggleClass(t.call(this, n, de(this), e), e)
                }) : this.each(function() {
                    var e, i, o, s;
                    if ("string" === n)
                        for (i = 0, o = v(this), s = t.match(N) || []; e = s[i++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                    else void 0 !== t && "boolean" !== n || (e = de(this), e && Z.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : Z.get(this, "__className__") || ""))
                })
            },
            hasClass: function(t) {
                var e, n, i = 0;
                for (e = " " + t + " "; n = this[i++];)
                    if (1 === n.nodeType && (" " + ue(de(n)) + " ").indexOf(e) > -1) return !0;
                return !1
            }
        });
        var pe = /\r/g;
                ...
                select: {
                    get: function(t) {
                        ...
                        for (i = s < 0 ? l : r ? s : 0; i < l; i++)
                            if (n = o[i], (n.selected || i === s) && !n.disabled && (!n.parentNode.disabled || !S(n.parentNode, "optgroup"))) {
                                if (e = v(n).val(), r) return e;
                                a.push(e)
                            } return a
                    },
                    set: function(t, e) {
                        for (var n, i, o = t.options, s = v.makeArray(e), r = o.length; r--;) i = o[r], (i.selected = v.inArray(v.valHooks.option.get(i), s) > -1) && (n = !0);
        ...
        v.extend(v.event, {
            trigger: function(e, n, o, s) {
                var r, a, l, h, c, d, p, f = [o || i],
                    g = u.call(e, "type") ? e.type : e,
                    m = u.call(e, "namespace") ? e.namespace.split(".") : [];
                if (a = l = o = o || i, 3 !== o.nodeType && 8 !== o.nodeType && !fe.test(g + v.event.triggered) && (g.indexOf(".") > -1 && (g = (m = g.split(".")).shift(), m.sort()), c = g.indexOf(":") < 0 && "on" + g, (e = e[v.expando] ? e : new v.Event(g, "object" == typeof e && e)).isTrigger = s ? 2 : 3, e.namespace = m.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = o), n = null == n ? [e] : v.makeArray(n, [e]), p = v.event.special[g] || {}, s || !p.trigger || !1 !== p.trigger.apply(o, n))) {
                    if (!s && !p.noBubble && !v.isWindow(o)) {
                        for (h = p.delegateType || g, fe.test(h + g) || (a = a.parentNode); a; a = a.parentNode) f.push(a), l = a;
                        l === (o.ownerDocument || i) && f.push(l.defaultView || l.parentWindow || t)
                    }
                    for (r = 0;
                        (a = f[r++]) && !e.isPropagationStopped();) e.type = r > 1 ? h : p.bindType || g, d = (Z.get(a, "events") || {})[e.type] && Z.get(a, "handle"), d && d.apply(a, n), d = c && a[c], d && d.apply && q(a) && (e.result = d.apply(a, n), !1 === e.result && e.preventDefault());
                    return e.type = g, s || e.isDefaultPrevented() || p._default && !1 !== p._default.apply(f.pop(), n) || !q(o) || c && v.isFunction(o[g]) && !v.isWindow(o) && ((l = o[c]) && (o[c] = null), v.event.triggered = g, o[g](), v.event.triggered = void 0, l && (o[c] = l)), e.result
                }
            },
        ...
        function xe(t, e, n, i) {
            ...
            if (Array.isArray(e)) v.each(e, function(e, o) {
                n || ye.test(t) ? i(t, o) : xe(t + "[" + ("object" == typeof o && null != o ? e : "") + "]", o, n, i)
            });
        ...
        v.param = function(t, e) {
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var t = this.type;
                    return this.name && !v(this).is(":disabled") && be.test(this.nodeName) && !_e.test(t) && (this.checked || !st.test(t))
                }).map(function(t, e) {
                    var n = v(this).val();
        ...
        De.href = ge.href, v.extend({
            ...
            ajaxSetup: function(t, e) {
                return e ? He(He(t, v.ajaxSettings), e) : He(v.ajaxSettings, t)
            },
            ajaxPrefilter: Le(ke),
            ajaxTransport: Le(Ae),
            ajax: function(e, n) {
                "object" == typeof e && (n = e, e = void 0), n = n || {};
                var o, s, r, a, l, h, c, u, d, p, f = v.ajaxSetup({}, n),
                    g = f.context || f,
                ...
                if (y.promise(C), f.url = ((e || f.url || ge.href) + "").replace(We, ge.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(N) || [""], null == f.crossDomain) {
                    h = i.createElement("a");
                    try {
                ...
                if (f.data && f.processData && "string" != typeof f.data && (f.data = v.param(f.data, f.traditional)), Ie(ke, f, n, C), c) return C;
                (u = v.event && f.global) && 0 == v.active++ && v.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Se.test(f.type), s = f.url.replace(Ce, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Te, "+")) : (p = f.url.slice(s.length), f.data && (s += (ve.test(s) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (s = s.replace(ze, "$1"), p = (ve.test(s) ? "&" : "?") + "_=" + me++ + p), f.url = s + p), f.ifModified && (v.lastModified[s] && C.setRequestHeader("If-Modified-Since", v.lastModified[s]), v.etag[s] && C.setRequestHeader("If-None-Match", v.etag[s])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && C.setRequestHeader("Content-Type", f.contentType), C.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Oe + "; q=0.01" : "") : f.accepts["*"]);
                for (d in f.headers) C.setRequestHeader(d, f.headers[d]);
                if (f.beforeSend && (!1 === f.beforeSend.call(g, C, f) || c)) return C.abort();
                if (T = "abort", w.add(f.complete), C.done(f.success), C.fail(f.error), o = Ie(Ae, f, n, C)) {
                ...
                function z(e, n, i, a) {
                    var h, d, p, b, x, T = n;
                    c || (c = !0, l && t.clearTimeout(l), o = void 0, r = a || "", C.readyState = e > 0 ? 4 : 0, h = e >= 200 && e < 300 || 304 === e, i && (b = function(t, e, n) {
        ...
        var Ne = {
            ...
            Pe = v.ajaxSettings.xhr();
        f.cors = !!Pe && "withCredentials" in Pe, f.ajax = Pe = !!Pe, v.ajaxTransport(function(e) {
            var n, i;
            if (f.cors || Pe && !e.crossDomain) return {
                send: function(o, s) {
                    var r, a = e.xhr();
        ...
        v.ajaxSetup({
            ...
            jsonpCallback: function() {
                var t = $e.pop() || v.expando + "_" + me++;
                return this[t] = !0, t
            }
        }), v.ajaxPrefilter("json jsonp", function(e, n, i) {
            var o, s, r, a = !1 !== e.jsonp && (Re.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Re.test(e.data) && "data");
            if (a || "jsonp" === e.dataTypes[0]) return o = e.jsonpCallback = v.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Re, "$1" + o) : !1 !== e.jsonp && (e.url += (ve.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function() {
                return r || v.error(o + " was not called"), r[0]
            }, e.dataTypes[0] = "json", s = t[o], t[o] = function() {
                r = arguments
            }, i.always(function() {
                void 0 === s ? v(t).removeProp(o) : t[o] = s, e[o] && (e.jsonpCallback = n.jsonpCallback, $e.push(o)), r && v.isFunction(s) && s(r[0]), r = s = void 0
            }), "script"
        }), f.createHTMLDocument = ((je = i.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === je.childNodes.length), v.parseHTML = function(t, e, n) {
            return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (f.createHTMLDocument ? ((o = (e = i.implementation.createHTMLDocument("")).createElement("base")).href = i.location.href, e.head.appendChild(o)) : e = i), s = W.exec(t), r = !n && [], s ? [e.createElement(s[1])] : (s = ft([t], e, r), r && r.length && v(r).remove(), v.merge([], s.childNodes)));
            var o, s, r
        }, v.fn.load = function(t, e, n) {
            var i, o, s, r = this,
                a = t.indexOf(" ");
            return a > -1 && (i = ue(t.slice(a)), t = t.slice(0, a)), v.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"), r.length > 0 && v.ajax({
                url: t,
                type: o || "GET",
                dataType: "html",
                data: e
            ...
            setOffset: function(t, e, n) {
                var i, o, s, r, a, l, h = v.css(t, "position"),
                    c = v(t),
                    u = {};
            ...
            v.fn[t] = function(i) {
                return B(this, function(t, i, o) {
                    var s;
                    return v.isWindow(t) ? s = t : 9 === t.nodeType && (s = t.defaultView), void 0 === o ? s ? s[e] : t[i] : void(s ? s.scrollTo(n ? s.pageXOffset : o, n ? o : s.pageYOffset) : t[i] = o)
                }, t, i, arguments.length)
            }
        }), v.each(["top", "left"], function(t, e) {
            v.cssHooks[e] = jt(f.pixelPosition, function(t, n) {
                if (n) return n = Pt(t, e), Ht.test(n) ? v(t).position()[e] + "px" : n
            })
        }), v.each({
            Height: "height",
            Width: "width"
            ...
            v.each({
                ...
                v.fn[i] = function(o, s) {
                    ...
                    return B(this, function(e, n, o) {
                        var s;
                        return v.isWindow(e) ? 0 === i.indexOf("outer") ? e["inner" + t] : e.document.documentElement["client" + t] : 9 === e.nodeType ? (s = e.documentElement, Math.max(e.body["scroll" + t], s["scroll" + t], e.body["offset" + t], s["offset" + t], s["client" + t])) : void 0 === o ? v.css(e, n, a) : v.style(e, n, o, a)
                    }, e, r ? o : void 0, r)
                }
            })
        }), v.fn.extend({
        ...
        return v.noConflict = function(e) {
            return t.$ === v && (t.$ = Fe), e && t.jQuery === v && (t.jQuery = Me), v
        }, e || (t.jQuery = t.$ = v), v
    }), function(t, e) {
        ...
        function s(t) {
            ...
            for (var i = t;
                ...
                var s = o,
                    ...
                    a = s.overflowX,
                    l = s.overflowY;
                /(auto|scroll|overlay)/.test(r + l + a) && ("absolute" !== e || ["relative", "absolute", "fixed"].indexOf(o.position) >= 0) && n.push(i)
            }
        ...
        var T, C = null,
            ...
            S = function() {
                var t = C;
                t && document.body.contains(t) || ((t = document.createElement("div")).setAttribute("data-tether-id", z()), c(t.style, {
                    top: 0,
                    left: 0,
                    position: "absolute"
                }), document.body.appendChild(t), C = t);
                var e = t.getAttribute("data-tether-id");
                return void 0 === E[e] && (E[e] = o(t), A(function() {
                    delete E[e]
                })), E[e]
            },
            W = null,
                        ...
                        if (void 0 !== this.bindings && this.bindings[t]) {
                            ...
                            for (; e < this.bindings[t].length;) {
                                var s = this.bindings[t][e],
                                    ...
                                    l = s.once,
                                    h = a;
                                void 0 === h && (h = this), r.apply(h, i), l ? this.bindings[t].splice(e, 1) : ++e
                            }
                        }
                    }
                }]), t
        ...
        var L = function() {
            ...
            I = (b = function() {
                ...
                for (var i = !0; i;) {
                    ...
                    if (null === h) return;
                    t = h, e = s, n = r, i = !0, a = h = void 0
                }
            });
        if (void 0 === x) throw new Error("You must include the utils.js file before tether.js");
        var H, N, P, j, s = (K = x.Utils).getScrollParents,
            l = (a = K.getBounds, K.getOffsetParent),
            d = (c = K.extend, K.addClass),
            u = K.removeClass,
            h = (m = K.updateClasses, A = K.defer, O = K.flush, K.getScrollBarSize),
            r = K.removeUtilElements,
            $ = function() {
        ...
        H = null, N = null, P = null, j = function t() {
            return void 0 !== N && N > 16 ? (N = Math.min(N - 16, 250), void(P = setTimeout(t, 250))) : void(void 0 !== H && y() - H < 10 || (null != P && (clearTimeout(P), P = null), H = y(), M(), N = y() - H))
        ...
        var F = {
            ...
            Y = function(t) {
                function e(t) {
                    var n = this;
                    i(this, e), I(Object.getPrototypeOf(e.prototype), "constructor", this).call(this), this.position = this.position.bind(this), R.push(this), this.history = [], this.setOptions(t, !1), x.modules.forEach(function(t) {
                ...
                return function(t, e) {
                    ...
                    value: function() {
                        var t = this;
                        this.disable(), R.forEach(function(e, n) {
                            e === t && R.splice(n, 1)
                        }), 0 === R.length && r()
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        if (this.enabled) {
                            this.clearCache();
                            var r = (t = this.targetAttachment, e = this.attachment, n = t.left, i = t.top, "auto" === n && (n = F[e.left]), "auto" === i && (i = B[e.top]), {
                                left: n,
                                top: i
                            });
                            ...
                            var c = this.cache("element-bounds", function() {
                                ...
                                u = c.width,
                                d = c.height;
                            if (0 === u && 0 === d && void 0 !== this.lastSize) {
                                var p = this.lastSize;
                            ...
                            var f = this.cache("target-bounds", function() {
                                ...
                                b = _(this.targetOffset, g);
                            m = w(m, y), v = w(v, b);
                            for (var T = f.left + v.left - m.left, C = f.top + v.top - m.top, z = 0; z < x.modules.length; ++z) {
                                var E = x.modules[z].position.call(this, {
                                    left: T,
                                    top: C,
                                    targetAttachment: r,
                                    targetPos: f,
                                ...
                                if (!1 === E) return !1;
                                void 0 !== E && "object" == typeof E && (C = E.top, T = E.left)
                            }
                            var S = {
                                    page: {
                                        top: C,
                            ...
                            return k.innerHeight > W.documentElement.clientHeight && (A = this.cache("scrollbar-size", h), S.viewport.bottom -= A.height), k.innerWidth > W.documentElement.clientWidth && (A = this.cache("scrollbar-size", h), S.viewport.right -= A.width), -1 !== ["", "static"].indexOf(W.body.style.position) && -1 !== ["", "static"].indexOf(W.body.parentElement.style.position) || (S.page.bottom = W.body.scrollHeight - C - d, S.page.right = W.body.scrollWidth - T - u), void 0 !== this.options.optimizations && !1 !== this.options.optimizations.moveElement && void 0 === this.targetModifier && function() {
                                ...
                                if (["Top", "Left", "Bottom", "Right"].forEach(function(t) {
                                    ...
                                    }), e.right = W.body.scrollWidth - e.left - i.width + s.right, e.bottom = W.body.scrollHeight - e.top - i.height + s.bottom, S.page.top >= e.top + s.top && S.page.bottom >= e.bottom && S.page.left >= e.left + s.left && S.page.right >= e.right) {
                                    var r = t.scrollTop,
                                        h = t.scrollLeft;
                                    S.offset = {
                                        top: S.page.top - e.top + r - s.top,
                                        left: S.page.left - e.left + h - s.left
                                    }
                                }
                            }(), this.move(S), this.history.unshift(S), this.history.length > 3 && this.history.pop(), s && O(), !0
                        }
                    }
                }, {
                    key: "move",
                            ...
                            var h = {
                                ...
                                u = function(t, n) {
                                    if (!1 !== (void 0 !== e.options.optimizations ? e.options.optimizations.gpu : null)) {
                                        var i = void 0,
                                            o = void 0;
                                        if (t.top ? (h.top = 0, i = n.top) : (h.bottom = 0, i = -n.bottom), t.left ? (h.left = 0, o = n.left) : (h.right = 0, o = -n.right), window.matchMedia) window.matchMedia("only screen and (min-resolution: 1.3dppx)").matches || window.matchMedia("only screen and (-webkit-min-device-pixel-ratio: 1.3)").matches || (o = Math.round(o), i = Math.round(i));
                                        h[$] = "translateX(" + o + "px) translateY(" + i + "px)", "msTransform" !== $ && (h[$] += " translateZ(0)")
                                    } else t.top ? h.top = n.top + "px" : h.bottom = n.bottom + "px", t.left ? h.left = n.left + "px" : h.right = n.right + "px"
                                },
                                d = !1;
                            if ((n.page.top || n.page.bottom) && (n.page.left || n.page.right) ? (h.position = "absolute", u(n.page, t.page)) : (n.viewport.top || n.viewport.bottom) && (n.viewport.left || n.viewport.right) ? (h.position = "fixed", u(n.viewport, t.viewport)) : void 0 !== n.offset && n.offset.top && n.offset.left ? function() {
                                    h.position = "absolute";
        ...
        var V = c(Y, x),
            ...
            }(), a = (K = x.Utils).getBounds, K.extend),
            X = (m = K.updateClasses, A = K.defer, ["left", "top", "right", "bottom"]);
        x.modules.push({
            position: function(t) {
                var e = this,
                    n = t.top,
                ...
                return this.options.constraints.forEach(function(t) {
                    ...
                    var _, b = ("scrollParent" === (_ = s) ? _ = e.scrollParents[0] : "window" === _ && (_ = [pageXOffset, pageYOffset, innerWidth + pageXOffset, innerHeight + pageYOffset]), _ === document && (_ = _.documentElement), void 0 !== _.nodeType && function() {
                        var t = _,
                            e = a(_),
                            n = e,
                    ...
                    "target" !== f && "both" !== f || (n < b[1] && "top" === v.top && (n += d, v.top = "bottom"), n + r > b[3] && "bottom" === v.top && (n -= d, v.top = "top")), "together" === f && ("top" === v.top && ("bottom" === y.top && n < b[1] ? (n += d, v.top = "bottom", n += r, y.top = "top") : "top" === y.top && n + r > b[3] && n - (r - d) >= b[1] && (n -= r - d, v.top = "bottom", y.top = "bottom")), "bottom" === v.top && ("top" === y.top && n + r > b[3] ? (n -= d, v.top = "top", n -= r, y.top = "bottom") : "bottom" === y.top && n < b[1] && n + (2 * r - d) <= b[3] && (n += r - d, v.top = "top", y.top = "top")), "middle" === v.top && (n + r > b[3] && "top" === y.top ? (n -= r, y.top = "bottom") : n < b[1] && "bottom" === y.top && (n += r, y.top = "top"))), "target" !== u && "both" !== u || (i < b[0] && "left" === v.left && (i += p, v.left = "right"), i + l > b[2] && "right" === v.left && (i -= p, v.left = "left")), "together" === u && (i < b[0] && "left" === v.left ? "right" === y.left ? (i += p, v.left = "right", i += l, y.left = "left") : "left" === y.left && (i += p, v.left = "right", i -= l, y.left = "right") : i + l > b[2] && "right" === v.left ? "left" === y.left ? (i -= p, v.left = "left", i -= l, y.left = "right") : "right" === y.left && (i -= p, v.left = "left", i += l, y.left = "left") : "center" === v.left && (i + l > b[2] && "left" === y.left ? (i -= l, y.left = "right") : i < b[0] && "right" === y.left && (i += l, y.left = "left"))), "element" !== f && "both" !== f || (n < b[1] && "bottom" === y.top && (n += r, y.top = "top"), n + r > b[3] && "top" === y.top && (n -= r, y.top = "bottom")), "element" !== u && "both" !== u || (i < b[0] && ("right" === y.left ? (i += l, y.left = "left") : "center" === y.left && (i += l / 2, y.left = "left")), i + l > b[2] && ("left" === y.left ? (i -= l, y.left = "right") : "center" === y.left && (i -= l / 2, y.left = "right"))), "string" == typeof c ? c = c.split(",").map(function(t) {
                        return t.trim()
                    }) : !0 === c && (c = ["top", "left", "right", "bottom"]), c = c || [];
                    var x, T, C = [],
                        z = [];
                    n < b[1] && (c.indexOf("top") >= 0 ? (n = b[1], C.push("top")) : z.push("top")), n + r > b[3] && (c.indexOf("bottom") >= 0 ? (n = b[3] - r, C.push("bottom")) : z.push("bottom")), i < b[0] && (c.indexOf("left") >= 0 ? (i = b[0], C.push("left")) : z.push("left")), i + l > b[2] && (c.indexOf("right") >= 0 ? (i = b[2] - l, C.push("right")) : z.push("right")), C.length && (T = void 0 !== e.options.pinnedClass ? e.options.pinnedClass : e.getClass("pinned"), g.push(T), C.forEach(function(t) {
                        g.push(T + "-" + t)
                    })), z.length && (x = void 0 !== e.options.outOfBoundsClass ? e.options.outOfBoundsClass : e.getClass("out-of-bounds"), g.push(x), z.forEach(function(t) {
                        g.push(x + "-" + t)
                    })), (C.indexOf("left") >= 0 || C.indexOf("right") >= 0) && (y.left = v.left = !1), (C.indexOf("top") >= 0 || C.indexOf("bottom") >= 0) && (y.top = v.top = !1), v.top === o.top && v.left === o.left && y.top === e.attachment.top && y.left === e.attachment.left || (e.updateAttachClasses(y, v), e.trigger("update", {
                        attachment: y,
                        targetAttachment: v
                    }))
                }), A(function() {
...
function add() {
    var t = $("#qtyval"),
        e = t.val();
    t.val(++e), e > 1 && $("#dec").removeAttr("disabled")
}

function remove() {
    var t = $("#qtyval"),
        e = t.val();
    e > 1 ? t.val(--e) : $("#dec").attr("disabled", "disabled")
}! function(t) {
...
function() {
    ...
    var e, n, i, o, s, r, a, l, h, c, u, d, p, f, g, m, v, y, w, _, b, x, T, C, z, E, S, W, k, A, O, D, L, I, H, N, P, j, $, R, M, F, B, q, U, Z, Q, Y, V, X, K, G, J, tt, et, nt, it, ot, st, rt, at, lt, ht, ct, ut, dt, pt, ft, gt, mt, vt, yt, wt, _t, bt, xt, Tt, Ct, zt, Et, St, Wt, kt, At, Ot, Dt, Lt, It, Ht, Nt, Pt, jt, $t, Rt, Mt, Ft, Bt, qt, Ut, Zt, Qt, Yt, Vt, Xt, Kt, Gt, Jt, te, ee, ne, ie, oe, se, re, ae, le, he, ce, ue, de, pe, fe, ge, me, ve, ye, we, _e, be, xe, Te, Ce, ze, Ee, Se, We, ke, Ae, Oe, De, Le, Ie = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
        ...
        Pe = (ue = jQuery, de = "alert", fe = "." + (pe = "bs.alert"), ge = ue.fn[de], me = {
            CLOSE: "close" + fe,
            CLOSED: "closed" + fe,
            CLICK_DATA_API: "click" + fe + ".data-api"
        }, ve = "alert", ye = "fade", we = "show", _e = function() {
            function e(n) {
            ...
            return e.prototype.close = function(t) {
                ...
                var e = Ne.getSelectorFromElement(t),
                    n = !1;
                return e && (n = ue(e)[0]), n || (n = ue(t).closest("." + ve)[0]), n
            }, e.prototype._triggerCloseEvent = function(t) {
                var e = ue.Event(me.CLOSE);
                return ue(t).trigger(e), e
            }, e.prototype._removeElement = function(t) {
                var e = this;
                return ue(t).removeClass(we), Ne.supportsTransitionEnd() && ue(t).hasClass(ye) ? void ue(t).one(Ne.TRANSITION_END, function(n) {
                    return e._destroyElement(t, n)
                }).emulateTransitionEnd(150) : void this._destroyElement(t)
            }, e.prototype._destroyElement = function(t) {
                ue(t).detach().trigger(me.CLOSED).remove()
            }, e._jQueryInterface = function(t) {
                return this.each(function() {
                    var n = ue(this),
                        i = n.data(pe);
                    i || (i = new e(this), n.data(pe, i)), "close" === t && i[t](this)
                })
        ...
        }(), ue(document).on(me.CLICK_DATA_API, '[data-dismiss="alert"]', _e._handleDismiss(new _e)), ue.fn[de] = _e._jQueryInterface, ue.fn[de].Constructor = _e, ue.fn[de].noConflict = function() {
            return ue.fn[de] = ge, _e._jQueryInterface
        }, Vt = jQuery, Xt = "button", Gt = "." + (Kt = "bs.button"), Jt = ".data-api", te = Vt.fn[Xt], ee = "active", ne = "btn", ie = "focus", oe = '[data-toggle^="button"]', se = '[data-toggle="buttons"]', re = "input", ae = ".active", le = ".btn", he = {
            CLICK_DATA_API: "click" + Gt + Jt,
            FOCUS_BLUR_DATA_API: "focus" + Gt + Jt + " blur" + Gt + Jt
        }, ce = function() {
            function e(n) {
                t(this, e), this._element = n
            }
            return e.prototype.toggle = function() {
                var t = !0,
                    e = Vt(this._element).closest(se)[0];
                if (e) {
                    var n = Vt(this._element).find(re)[0];
                    if (n) {
                        if ("radio" === n.type)
                            if (n.checked && Vt(this._element).hasClass(ee)) t = !1;
                            else {
                                var i = Vt(e).find(ae)[0];
                                i && Vt(i).removeClass(ee)
                            } t && (n.checked = !Vt(this._element).hasClass(ee), Vt(n).trigger("change")), n.focus()
                    }
                }
                this._element.setAttribute("aria-pressed", !Vt(this._element).hasClass(ee)), t && Vt(this._element).toggleClass(ee)
            }, e.prototype.dispose = function() {
                Vt.removeData(this._element, Kt), this._element = null
            }, e._jQueryInterface = function(t) {
                return this.each(function() {
                    var n = Vt(this).data(Kt);
                    n || (n = new e(this), Vt(this).data(Kt, n)), "toggle" === t && n[t]()
                })
            }, He(e, null, [{
                key: "VERSION",
                get: function() {
        ...
        }(), Vt(document).on(he.CLICK_DATA_API, oe, function(t) {
            t.preventDefault();
            var e = t.target;
            Vt(e).hasClass(ne) || (e = Vt(e).closest(le)), ce._jQueryInterface.call(Vt(e), "toggle")
        }).on(he.FOCUS_BLUR_DATA_API, oe, function(t) {
            var e = Vt(t.target).closest(le)[0];
            Vt(e).toggleClass(ie, /^focus(in)?$/.test(t.type))
        }), Vt.fn[Xt] = ce._jQueryInterface, Vt.fn[Xt].Constructor = ce, Vt.fn[Xt].noConflict = function() {
            return Vt.fn[Xt] = te, ce._jQueryInterface
        }, At = jQuery, Ot = "carousel", Lt = "." + (Dt = "bs.carousel"), It = ".data-api", Ht = At.fn[Ot], Nt = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
            ...
            LOAD_DATA_API: "load" + Lt + It,
            CLICK_DATA_API: "click" + Lt + It
        }, Rt = "carousel", Mt = "active", Ft = "slide", Bt = "carousel-item-right", qt = "carousel-item-left", Ut = "carousel-item-next", Zt = "carousel-item-prev", Qt = {
            ACTIVE: ".active",
            ...
            function e(n, i) {
                t(this, e), this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this._config = this._getConfig(i), this._element = At(n)[0], this._indicatorsElement = At(this._element).find(Qt.INDICATORS)[0], this._addEventListeners()
            }
            return e.prototype.next = function() {
                ...
                if (this._isSliding) throw new Error("Carousel is sliding");
                this._slide(jt.PREVIOUS)
            }, e.prototype.pause = function(t) {
                t || (this._isPaused = !0), At(this._element).find(Qt.NEXT_PREV)[0] && Ne.supportsTransitionEnd() && (Ne.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }, e.prototype.cycle = function(t) {
                t || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config.interval && !this._isPaused && (this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval))
            }, e.prototype.to = function(t) {
                var e = this;
                this._activeElement = At(this._element).find(Qt.ACTIVE_ITEM)[0];
                var n = this._getItemIndex(this._activeElement);
                if (!(t > this._items.length - 1 || t < 0)) {
                    if (this._isSliding) return void At(this._element).one($t.SLID, function() {
                        return e.to(t)
                    });
                    if (n === t) return this.pause(), void this.cycle();
                    var i = t > n ? jt.NEXT : jt.PREVIOUS;
                    this._slide(i, this._items[t])
                }
            }, e.prototype.dispose = function() {
                At(this._element).off(Lt), At.removeData(this._element, Dt), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, e.prototype._getConfig = function(t) {
                return t = At.extend({}, Nt, t), Ne.typeCheckConfig(Ot, t, Pt), t
            }, e.prototype._addEventListeners = function() {
                var t = this;
                this._config.keyboard && At(this._element).on($t.KEYDOWN, function(e) {
                    return t._keydown(e)
                }), "hover" !== this._config.pause || "ontouchstart" in document.documentElement || At(this._element).on($t.MOUSEENTER, function(e) {
                    return t.pause(e)
                ...
                return this._items = At.makeArray(At(t).parent().find(Qt.ITEM)), this._items.indexOf(t)
                ...
                var r = (o + (t === jt.PREVIOUS ? -1 : 1)) % this._items.length;
                return -1 === r ? this._items[this._items.length - 1] : this._items[r]
            }, e.prototype._triggerSlideEvent = function(t, e) {
                var n = At.Event($t.SLIDE, {
                    relatedTarget: t,
                    direction: e
                });
                return At(this._element).trigger(n), n
            }, e.prototype._setActiveIndicatorElement = function(t) {
                if (this._indicatorsElement) {
                    At(this._indicatorsElement).find(Qt.ACTIVE).removeClass(Mt);
                    var e = this._indicatorsElement.children[this._getItemIndex(t)];
                    e && At(e).addClass(Mt)
                }
            }, e.prototype._slide = function(t, e) {
                var n = this,
                    i = At(this._element).find(Qt.ACTIVE_ITEM)[0],
                    o = e || i && this._getItemByDirection(t, i),
                    s = Boolean(this._interval),
                    r = void 0,
                    a = void 0,
                    l = void 0;
                if (t === jt.NEXT ? (r = qt, a = Ut, l = jt.LEFT) : (r = Bt, a = Zt, l = jt.RIGHT), o && At(o).hasClass(Mt)) this._isSliding = !1;
                    ...
                    var h = At.Event($t.SLID, {
                        relatedTarget: o,
                        direction: l
                    });
                    Ne.supportsTransitionEnd() && At(this._element).hasClass(Ft) ? (At(o).addClass(a), Ne.reflow(o), At(i).addClass(r), At(o).addClass(r), At(i).one(Ne.TRANSITION_END, function() {
                        At(o).removeClass(r + " " + a).addClass(Mt), At(i).removeClass(Mt + " " + a + " " + r), n._isSliding = !1, setTimeout(function() {
                            return At(n._element).trigger(h)
                        }, 0)
                    }).emulateTransitionEnd(600)) : (At(i).removeClass(Mt), At(o).addClass(Mt), this._isSliding = !1, At(this._element).trigger(h)), s && this.cycle()
                }
            }, e._jQueryInterface = function(t) {
                return this.each(function() {
                    var n = At(this).data(Dt),
                        i = At.extend({}, Nt, At(this).data());
                    "object" === (void 0 === t ? "undefined" : Ie(t)) && At.extend(i, t);
                    var o = "string" == typeof t ? t : i.slide;
                    if (n || (n = new e(this, i), At(this).data(Dt, n)), "number" == typeof t) n.to(t);
                ...
                if (n) {
                    var i = At(n)[0];
                    if (i && At(i).hasClass(Rt)) {
                        var o = At.extend({}, At(i).data(), At(this).data()),
                            s = this.getAttribute("data-slide-to");
                        s && (o.interval = !1), e._jQueryInterface.call(At(i), o), s && At(i).data(Dt).to(s), t.preventDefault()
                    }
                }
            }, He(e, null, [{
                key: "VERSION",
        ...
        }(), At(document).on($t.CLICK_DATA_API, Qt.DATA_SLIDE, Yt._dataApiClickHandler), At(window).on($t.LOAD_DATA_API, function() {
            At(Qt.DATA_RIDE).each(function() {
                var t = At(this);
                Yt._jQueryInterface.call(t, t.data())
            })
        }), At.fn[Ot] = Yt._jQueryInterface, At.fn[Ot].Constructor = Yt, At.fn[Ot].noConflict = function() {
            return At.fn[Ot] = Ht, Yt._jQueryInterface
        }, pt = jQuery, ft = "collapse", mt = "." + (gt = "bs.collapse"), vt = pt.fn[ft], yt = {
            toggle: !0,
            parent: ""
        }, wt = {
            toggle: "boolean",
        ...
        }, bt = "show", xt = "collapse", Tt = "collapsing", Ct = "collapsed", zt = "width", Et = "height", St = ".card > .show, .card > .collapsing", Wt = '[data-toggle="collapse"]', kt = function() {
            function e(n, i) {
                t(this, e), this._isTransitioning = !1, this._element = n, this._config = this._getConfig(i), this._triggerArray = pt.makeArray(pt('[data-toggle="collapse"][href="#' + n.id + '"],[data-toggle="collapse"][data-target="#' + n.id + '"]')), this._parent = this._config.parent ? this._getParent() : null, this._config.parent || this._addAriaAndCollapsedClass(this._element, this._triggerArray), this._config.toggle && this.toggle()
            }
            return e.prototype.toggle = function() {
                pt(this._element).hasClass(bt) ? this.hide() : this.show()
            }, e.prototype.show = function() {
                var t = this;
                if (this._isTransitioning) throw new Error("Collapse is transitioning");
                if (!pt(this._element).hasClass(bt)) {
                    var n = void 0,
                        i = void 0;
                    if (this._parent && ((n = pt.makeArray(pt(this._parent).find(St))).length || (n = null)), !(n && (i = pt(n).data(gt), i && i._isTransitioning))) {
                        var o = pt.Event(_t.SHOW);
                        if (pt(this._element).trigger(o), !o.isDefaultPrevented()) {
                            n && (e._jQueryInterface.call(pt(n), "hide"), i || pt(n).data(gt, null));
                            var s = this._getDimension();
                            pt(this._element).removeClass(xt).addClass(Tt), this._element.style[s] = 0, this._element.setAttribute("aria-expanded", !0), this._triggerArray.length && pt(this._triggerArray).removeClass(Ct).attr("aria-expanded", !0), this.setTransitioning(!0);
                            var r = function() {
                                pt(t._element).removeClass(Tt).addClass(xt).addClass(bt), t._element.style[s] = "", t.setTransitioning(!1), pt(t._element).trigger(_t.SHOWN)
                            };
                            if (!Ne.supportsTransitionEnd()) return void r();
                            var a = "scroll" + (s[0].toUpperCase() + s.slice(1));
                            pt(this._element).one(Ne.TRANSITION_END, r).emulateTransitionEnd(600), this._element.style[s] = this._element[a] + "px"
                        }
                    }
                }
                ...
                if (this._isTransitioning) throw new Error("Collapse is transitioning");
                if (pt(this._element).hasClass(bt)) {
                    var e = pt.Event(_t.HIDE);
                    if (pt(this._element).trigger(e), !e.isDefaultPrevented()) {
                        var n = this._getDimension(),
                            i = n === zt ? "offsetWidth" : "offsetHeight";
                        this._element.style[n] = this._element[i] + "px", Ne.reflow(this._element), pt(this._element).addClass(Tt).removeClass(xt).removeClass(bt), this._element.setAttribute("aria-expanded", !1), this._triggerArray.length && pt(this._triggerArray).addClass(Ct).attr("aria-expanded", !1), this.setTransitioning(!0);
                        var o = function() {
                            t.setTransitioning(!1), pt(t._element).removeClass(Tt).addClass(xt).trigger(_t.HIDDEN)
                        };
                        return this._element.style[n] = "", Ne.supportsTransitionEnd() ? void pt(this._element).one(Ne.TRANSITION_END, o).emulateTransitionEnd(600) : void o()
                    }
                }
            }, e.prototype.setTransitioning = function(t) {
                this._isTransitioning = t
            }, e.prototype.dispose = function() {
                pt.removeData(this._element, gt), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
            }, e.prototype._getConfig = function(t) {
                return (t = pt.extend({}, yt, t)).toggle = Boolean(t.toggle), Ne.typeCheckConfig(ft, t, wt), t
            }, e.prototype._getDimension = function() {
                return pt(this._element).hasClass(zt) ? zt : Et
            }, e.prototype._getParent = function() {
                var t = this,
                    n = pt(this._config.parent)[0],
                    i = '[data-toggle="collapse"][data-parent="' + this._config.parent + '"]';
                return pt(n).find(i).each(function(n, i) {
                    t._addAriaAndCollapsedClass(e._getTargetFromElement(i), [i])
                }), n
            }, e.prototype._addAriaAndCollapsedClass = function(t, e) {
                if (t) {
                    var n = pt(t).hasClass(bt);
                    t.setAttribute("aria-expanded", n), e.length && pt(e).toggleClass(Ct, !n).attr("aria-expanded", n)
                }
                ...
                return this.each(function() {
                    var n = pt(this),
                        i = n.data(gt),
                        o = pt.extend({}, yt, n.data(), "object" === (void 0 === t ? "undefined" : Ie(t)) && t);
                    if (!i && o.toggle && /show|hide/.test(t) && (o.toggle = !1), i || (i = new e(this, o), n.data(gt, i)), "string" == typeof t) {
        ...
        }(), pt(document).on(_t.CLICK_DATA_API, Wt, function(t) {
            t.preventDefault();
            var e = kt._getTargetFromElement(this),
                n = pt(e).data(gt) ? "toggle" : pt(this).data();
            kt._jQueryInterface.call(pt(e), n)
        }), pt.fn[ft] = kt._jQueryInterface, pt.fn[ft].Constructor = kt, pt.fn[ft].noConflict = function() {
            return pt.fn[ft] = vt, kt._jQueryInterface
        }, V = jQuery, X = "dropdown", G = "." + (K = "bs.dropdown"), J = ".data-api", tt = V.fn[X], et = {
            HIDE: "hide" + G,
            HIDDEN: "hidden" + G,
            SHOW: "show" + G,
            SHOWN: "shown" + G,
            ...
            FOCUSIN_DATA_API: "focusin" + G + J,
            KEYDOWN_DATA_API: "keydown" + G + J
        }, nt = "dropdown-backdrop", it = "disabled", ot = "show", st = ".dropdown-backdrop", rt = '[data-toggle="dropdown"]', at = ".dropdown form", lt = '[role="menu"]', ht = '[role="listbox"]', ct = ".navbar-nav", ut = '[role="menu"] li:not(.disabled) a, [role="listbox"] li:not(.disabled) a', dt = function() {
            function e(n) {
                t(this, e), this._element = n, this._addEventListeners()
            }
            return e.prototype.toggle = function() {
                if (this.disabled || V(this).hasClass(it)) return !1;
                var t = e._getParentFromElement(this),
                    n = V(t).hasClass(ot);
                if (e._clearMenus(), n) return !1;
                if ("ontouchstart" in document.documentElement && !V(t).closest(ct).length) {
                    var i = document.createElement("div");
                    i.className = nt, V(i).insertBefore(this), V(i).on("click", e._clearMenus)
                }
                var o = {
                        relatedTarget: this
                    },
                    s = V.Event(et.SHOW, o);
                return V(t).trigger(s), !s.isDefaultPrevented() && (this.focus(), this.setAttribute("aria-expanded", !0), V(t).toggleClass(ot), V(t).trigger(V.Event(et.SHOWN, o)), !1)
            }, e.prototype.dispose = function() {
                V.removeData(this._element, K), V(this._element).off(G), this._element = null
            }, e.prototype._addEventListeners = function() {
                V(this._element).on(et.CLICK, this.toggle)
            }, e._jQueryInterface = function(t) {
                return this.each(function() {
                    var n = V(this).data(K);
                    if (n || (n = new e(this), V(this).data(K, n)), "string" == typeof t) {
                ...
                if (!t || 3 !== t.which) {
                    ...
                    for (var i = V.makeArray(V(rt)), o = 0; o < i.length; o++) {
                        var s = e._getParentFromElement(i[o]),
                            r = {
                                relatedTarget: i[o]
                            };
                        if (V(s).hasClass(ot) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "focusin" === t.type) && V.contains(s, t.target))) {
                            var a = V.Event(et.HIDE, r);
                            V(s).trigger(a), a.isDefaultPrevented() || (i[o].setAttribute("aria-expanded", "false"), V(s).removeClass(ot).trigger(V.Event(et.HIDDEN, r)))
                        }
                    }
                }
                ...
                if (/(38|40|27|32)/.test(t.which) && !/input|textarea/i.test(t.target.tagName) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !V(this).hasClass(it))) {
                    ...
                    if (!i && 27 !== t.which || i && 27 === t.which) {
                        ...
                        return void V(this).trigger("click")
                    }
                    var s = V(n).find(ut).get();
                    if (s.length) {
        ...
        }(), V(document).on(et.KEYDOWN_DATA_API, rt, dt._dataApiKeydownHandler).on(et.KEYDOWN_DATA_API, lt, dt._dataApiKeydownHandler).on(et.KEYDOWN_DATA_API, ht, dt._dataApiKeydownHandler).on(et.CLICK_DATA_API + " " + et.FOCUSIN_DATA_API, dt._clearMenus).on(et.CLICK_DATA_API, rt, dt.prototype.toggle).on(et.CLICK_DATA_API, at, function(t) {
            t.stopPropagation()
        }), V.fn[X] = dt._jQueryInterface, V.fn[X].Constructor = dt, V.fn[X].noConflict = function() {
            return V.fn[X] = tt, dt._jQueryInterface
        }, I = jQuery, H = "modal", P = "." + (N = "bs.modal"), j = I.fn[H], $ = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
        ...
        }, F = "modal-scrollbar-measure", B = "modal-backdrop", q = "modal-open", U = "fade", Z = "show", Q = {
            DIALOG: ".modal-dialog",
            ...
            function e(n, i) {
                t(this, e), this._config = this._getConfig(i), this._element = n, this._dialog = I(n).find(Q.DIALOG)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._originalBodyPadding = 0, this._scrollbarWidth = 0
            }
            return e.prototype.toggle = function(t) {
                ...
                Ne.supportsTransitionEnd() && I(this._element).hasClass(U) && (this._isTransitioning = !0);
                var n = I.Event(M.SHOW, {
                    relatedTarget: t
                });
                I(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), I(document.body).addClass(q), this._setEscapeEvent(), this._setResizeEvent(), I(this._element).on(M.CLICK_DISMISS, Q.DATA_DISMISS, function(t) {
                    return e.hide(t)
                }), I(this._dialog).on(M.MOUSEDOWN_DISMISS, function() {
                    I(e._element).one(M.MOUSEUP_DISMISS, function(t) {
                ...
                var n = Ne.supportsTransitionEnd() && I(this._element).hasClass(U);
                n && (this._isTransitioning = !0);
                var i = I.Event(M.HIDE);
                I(this._element).trigger(i), this._isShown && !i.isDefaultPrevented() && (this._isShown = !1, this._setEscapeEvent(), this._setResizeEvent(), I(document).off(M.FOCUSIN), I(this._element).removeClass(Z), I(this._element).off(M.CLICK_DISMISS), I(this._dialog).off(M.MOUSEDOWN_DISMISS), n ? I(this._element).one(Ne.TRANSITION_END, function(t) {
                    return e._hideModal(t)
                }).emulateTransitionEnd(300) : this._hideModal())
            }, e.prototype.dispose = function() {
                I.removeData(this._element, N), I(window, document, this._element, this._backdrop).off(P), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._originalBodyPadding = null, this._scrollbarWidth = null
            }, e.prototype._getConfig = function(t) {
                return t = I.extend({}, $, t), Ne.typeCheckConfig(H, t, R), t
            }, e.prototype._showElement = function(t) {
                var e = this,
                    n = Ne.supportsTransitionEnd() && I(this._element).hasClass(U);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, n && Ne.reflow(this._element), I(this._element).addClass(Z), this._config.focus && this._enforceFocus();
                var i = I.Event(M.SHOWN, {
                        relatedTarget: t
                    }),
                    o = function() {
                        e._config.focus && e._element.focus(), e._isTransitioning = !1, I(e._element).trigger(i)
                    };
                n ? I(this._dialog).one(Ne.TRANSITION_END, o).emulateTransitionEnd(300) : o()
            }, e.prototype._enforceFocus = function() {
                var t = this;
                I(document).off(M.FOCUSIN).on(M.FOCUSIN, function(e) {
                ...
                var t = this;
                this._isShown && this._config.keyboard ? I(this._element).on(M.KEYDOWN_DISMISS, function(e) {
                    27 === e.which && t.hide()
                }) : this._isShown || I(this._element).off(M.KEYDOWN_DISMISS)
            }, e.prototype._setResizeEvent = function() {
                var t = this;
                this._isShown ? I(window).on(M.RESIZE, function(e) {
                    return t._handleUpdate(e)
                }) : I(window).off(M.RESIZE)
            }, e.prototype._hideModal = function() {
                var t = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", "true"), this._isTransitioning = !1, this._showBackdrop(function() {
                    I(document.body).removeClass(q), t._resetAdjustments(), t._resetScrollbar(), I(t._element).trigger(M.HIDDEN)
                })
            }, e.prototype._removeBackdrop = function() {
                this._backdrop && (I(this._backdrop).remove(), this._backdrop = null)
            }, e.prototype._showBackdrop = function(t) {
                var e = this,
                    n = I(this._element).hasClass(U) ? U : "";
                if (this._isShown && this._config.backdrop) {
                    var i = Ne.supportsTransitionEnd() && n;
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = B, n && I(this._backdrop).addClass(n), I(this._backdrop).appendTo(document.body), I(this._element).on(M.CLICK_DISMISS, function(t) {
                        ...
                        }), i && Ne.reflow(this._backdrop), I(this._backdrop).addClass(Z), !t) return;
                    if (!i) return void t();
                    I(this._backdrop).one(Ne.TRANSITION_END, t).emulateTransitionEnd(150)
                } else if (!this._isShown && this._backdrop) {
                    I(this._backdrop).removeClass(Z);
                    var o = function() {
                        e._removeBackdrop(), t && t()
                    };
                    Ne.supportsTransitionEnd() && I(this._element).hasClass(U) ? I(this._backdrop).one(Ne.TRANSITION_END, o).emulateTransitionEnd(150) : o()
                } else t && t()
                ...
                var t = parseInt(I(Q.FIXED_CONTENT).css("padding-right") || 0, 10);
                ...
                return this.each(function() {
                    var i = I(this).data(N),
                        o = I.extend({}, e.Default, I(this).data(), "object" === (void 0 === t ? "undefined" : Ie(t)) && t);
                    if (i || (i = new e(this, o), I(this).data(N, i)), "string" == typeof t) {
                        if (void 0 === i[t]) throw new Error('No method named "' + t + '"');
                        i[t](n)
        ...
        }(), I(document).on(M.CLICK_DATA_API, Q.DATA_TOGGLE, function(t) {
            var e = this,
                n = void 0,
                i = Ne.getSelectorFromElement(this);
            i && (n = I(i)[0]);
            var o = I(n).data(N) ? "toggle" : I.extend({}, I(n).data(), I(this).data());
            "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault();
            var s = I(n).one(M.SHOW, function(t) {
                t.isDefaultPrevented() || s.one(M.HIDDEN, function() {
                    I(e).is(":visible") && e.focus()
                })
            });
            Y._jQueryInterface.call(I(n), o, this)
        }), I.fn[H] = Y._jQueryInterface, I.fn[H].Constructor = Y, I.fn[H].noConflict = function() {
            return I.fn[H] = j, Y._jQueryInterface
        }, _ = jQuery, b = "scrollspy", T = "." + (x = "bs.scrollspy"), C = _.fn[b], z = {
            offset: 10,
            method: "auto",
            target: ""
        }, E = {
        ...
        }, O = "offset", D = "position", L = function() {
            function e(n, i) {
                var o = this;
                t(this, e), this._element = n, this._scrollElement = "BODY" === n.tagName ? window : n, this._config = this._getConfig(i), this._selector = this._config.target + " " + A.NAV_LINKS + "," + this._config.target + " " + A.DROPDOWN_ITEMS, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, _(this._scrollElement).on(S.SCROLL, function(t) {
                    return o._process(t)
            ...
            return e.prototype.refresh = function() {
                ...
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), _.makeArray(_(this._selector)).map(function(t) {
                    var e = void 0,
                        o = Ne.getSelectorFromElement(t);
                    return o && (e = _(o)[0]), e && (e.offsetWidth || e.offsetHeight) ? [_(e)[n]().top + i, o] : null
                }).filter(function(t) {
                    return t
                }).sort(function(t, e) {
                    return t[0] - e[0]
                ...
                _.removeData(this._element, x), _(this._scrollElement).off(T), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, e.prototype._getConfig = function(t) {
                if ("string" != typeof(t = _.extend({}, z, t)).target) {
                    var e = _(t.target).attr("id");
                    e || (e = Ne.getUID(b), _(t.target).attr("id", e)), t.target = "#" + e
                }
                return Ne.typeCheckConfig(b, t, E), t
                ...
                var n = _(e.join(","));
                n.hasClass(W) ? (n.closest(A.DROPDOWN).find(A.DROPDOWN_TOGGLE).addClass(k), n.addClass(k)) : n.parents(A.LI).find("> " + A.NAV_LINKS).addClass(k), _(this._scrollElement).trigger(S.ACTIVATE, {
                    relatedTarget: t
                })
            }, e.prototype._clear = function() {
                _(this._selector).filter(A.ACTIVE).removeClass(k)
            }, e._jQueryInterface = function(t) {
                return this.each(function() {
                    var n = _(this).data(x),
                        i = "object" === (void 0 === t ? "undefined" : Ie(t)) && t;
                    if (n || (n = new e(this, i), _(this).data(x, n)), "string" == typeof t) {
                        if (void 0 === n[t]) throw new Error('No method named "' + t + '"');
                        n[t]()
                    }
                })
        ...
        }(), _(window).on(S.LOAD_DATA_API, function() {
            for (var t = _.makeArray(_(A.DATA_SPY)), e = t.length; e--;) {
                var n = _(t[e]);
                L._jQueryInterface.call(n, n.data())
            }
        }), _.fn[b] = L._jQueryInterface, _.fn[b].Constructor = L, _.fn[b].noConflict = function() {
            return _.fn[b] = C, L._jQueryInterface
        }, e = jQuery, i = "." + (n = "bs.tab"), o = e.fn.tab, s = {
            HIDE: "hide" + i,
            HIDDEN: "hidden" + i,
            SHOW: "show" + i,
            SHOWN: "shown" + i,
            CLICK_DATA_API: "click" + i + ".data-api"
        }, r = "dropdown-menu", a = "active", l = "disabled", h = "fade", c = "show", u = ".dropdown", d = "ul:not(.dropdown-menu), ol:not(.dropdown-menu), nav:not(.dropdown-menu)", p = "> .nav-item .fade, > .fade", f = ".active", g = "> .nav-item > .active, > .active", m = '[data-toggle="tab"], [data-toggle="pill"]', v = ".dropdown-toggle", y = "> .dropdown-menu .active", w = function() {
            function i(e) {
            ...
            return i.prototype.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(a) || e(this._element).hasClass(l))) {
                    ...
                    var h = e.Event(s.HIDE, {
                            relatedTarget: this._element
                        }),
                        c = e.Event(s.SHOW, {
                            relatedTarget: i
                        });
                    if (i && e(i).trigger(h), e(this._element).trigger(c), !c.isDefaultPrevented() && !h.isDefaultPrevented()) {
                ...
                var o = this,
                    s = e(n).find(g)[0],
                    r = i && Ne.supportsTransitionEnd() && (s && e(s).hasClass(h) || Boolean(e(n).find(p)[0])),
                    a = function() {
                        return o._transitionComplete(t, s, r, i)
                    };
                s && r ? e(s).one(Ne.TRANSITION_END, a).emulateTransitionEnd(150) : a(), s && e(s).removeClass(c)
            }, i.prototype._transitionComplete = function(t, n, i, o) {
                if (n) {
                    e(n).removeClass(a);
                    var s = e(n.parentNode).find(y)[0];
                    s && e(s).removeClass(a), n.setAttribute("aria-expanded", !1)
                }
                if (e(t).addClass(a), t.setAttribute("aria-expanded", !0), i ? (Ne.reflow(t), e(t).addClass(c)) : e(t).removeClass(h), t.parentNode && e(t.parentNode).hasClass(r)) {
                    var l = e(t).closest(u)[0];
                    l && e(l).find(v).addClass(a), t.setAttribute("aria-expanded", !0)
                }
                o && o()
                ...
                return this.each(function() {
                    var o = e(this),
                        s = o.data(n);
                    if (s || (s = new i(this), o.data(n, s)), "string" == typeof t) {
            ...
            var n = "tooltip",
                ...
                _ = function() {
                    function s(e, n) {
                        t(this, s), this._isEnabled = !0, this._timeout = 0, this._hoverState = "", this._activeTrigger = {}, this._isTransitioning = !1, this._tether = null, this.element = e, this.config = this._getConfig(n), this.tip = null, this._setListeners()
                    }
                    return s.prototype.enable = function() {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            var o = this.getTipElement(),
                                r = Ne.getUID(this.constructor.NAME);
                            o.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && e(o).addClass(d);
                            var a = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
                                l = this._getAttachment(a),
                                h = !1 === this.config.container ? document.body : e(this.config.container);
                            e(o).data(this.constructor.DATA_KEY, this).appendTo(h), e(this.element).trigger(this.constructor.Event.INSERTED), this._tether = new Tether({
                                attachment: l,
                                element: o,
                                target: this.element,
                                classes: g,
                                ...
                                addTargetClasses: !1
                            }), Ne.reflow(o), this._tether.position(), e(o).addClass(p);
                            var u = function() {
                                var n = t._hoverState;
                                t._hoverState = null, t._isTransitioning = !1, e(t.element).trigger(t.constructor.Event.SHOWN), n === c && t._leave(null, t)
                            };
                            if (Ne.supportsTransitionEnd() && e(this.tip).hasClass(d)) return this._isTransitioning = !0, void e(this.tip).one(Ne.TRANSITION_END, u).emulateTransitionEnd(s._TRANSITION_DURATION);
                            u()
                        }
                        ...
                        if (this._isTransitioning) throw new Error("Tooltip is transitioning");
                        var s = function() {
                            n._hoverState !== h && i.parentNode && i.parentNode.removeChild(i), n.element.removeAttribute("aria-describedby"), e(n.element).trigger(n.constructor.Event.HIDDEN), n._isTransitioning = !1, n.cleanupTether(), t && t()
                        };
                        e(this.element).trigger(o), o.isDefaultPrevented() || (e(i).removeClass(p), this._activeTrigger[y] = !1, this._activeTrigger[v] = !1, this._activeTrigger[m] = !1, Ne.supportsTransitionEnd() && e(this.tip).hasClass(d) ? (this._isTransitioning = !0, e(i).one(Ne.TRANSITION_END, s).emulateTransitionEnd(150)) : s(), this._hoverState = "")
                        ...
                        this.setElementContent(t.find(f), this.getTitle()), t.removeClass(d + " " + p), this.cleanupTether()
                    }, s.prototype.setElementContent = function(t, n) {
                        var i = this.config.html;
                        "object" === (void 0 === n ? "undefined" : Ie(n)) && (n.nodeType || n.jquery) ? i ? e(n).parent().is(t) || t.empty().append(n) : t.text(e(n).text()): t[i ? "html" : "text"](n)
                        ...
                        this.config.trigger.split(" ").forEach(function(n) {
                            if ("click" === n) e(t.element).on(t.constructor.Event.CLICK, t.config.selector, function(e) {
                                ...
                                var i = n === m ? t.constructor.Event.MOUSEENTER : t.constructor.Event.FOCUSIN,
                                    o = n === m ? t.constructor.Event.MOUSELEAVE : t.constructor.Event.FOCUSOUT;
                        ...
                        var t = Ie(this.element.getAttribute("data-original-title"));
                        ...
                        return (t = e.extend({}, this.constructor.Default, e(this.element).data(), t)).delay && "number" == typeof t.delay && (t.delay = {
                            show: t.delay,
                            hide: t.delay
                        }), Ne.typeCheckConfig(n, t, this.constructor.DefaultType), t
                        ...
                        return this.each(function() {
                            var n = e(this).data(i),
                                o = "object" === (void 0 === t ? "undefined" : Ie(t)) && t;
                            if ((n || !/dispose|hide/.test(t)) && (n || (n = new s(this, o), e(this).data(i, n)), "string" == typeof t)) {
                                if (void 0 === n[t]) throw new Error('No method named "' + t + '"');
                                n[t]()
                            }
                        })
            ...
            return e.fn[n] = _._jQueryInterface, e.fn[n].Constructor = _, e.fn[n].noConflict = function() {
                return e.fn[n] = s, _._jQueryInterface
            }, _
        }(jQuery));
    be = jQuery, xe = "popover", Ce = "." + (Te = "bs.popover"), ze = be.fn[xe], Ee = be.extend({}, Pe.Default, {
        placement: "right",
        trigger: "click",
        content: "",
        template: '<div class="popover" role="tooltip"><h3 class="popover-title"></h3><div class="popover-content"></div></div>'
    }), Se = be.extend({}, Pe.DefaultType, {
        content: "(string|element|function)"
    }), We = "fade", ke = "show", Ae = ".popover-title", Oe = ".popover-content", De = {
        HIDE: "hide" + Ce,
        HIDDEN: "hidden" + Ce,
        SHOW: "show" + Ce,
        SHOWN: "shown" + Ce,
        ...
        return function(t, e) {
            ...
            this.setElementContent(t.find(Ae), this.getTitle()), this.setElementContent(t.find(Oe), this._getContent()), t.removeClass(We + " " + ke), this.cleanupTether()
        }, n.prototype._getContent = function() {
            return this.element.getAttribute("data-content") || ("function" == typeof this.config.content ? this.config.content.call(this.element) : this.config.content)
        }, n._jQueryInterface = function(t) {
            return this.each(function() {
                var e = be(this).data(Te),
                    i = "object" === (void 0 === t ? "undefined" : Ie(t)) ? t : null;
                if ((e || !/destroy|hide/.test(t)) && (e || (e = new n(this, i), be(this).data(Te, e)), "string" == typeof t)) {
    ...
    }(Pe), be.fn[xe] = Le._jQueryInterface, be.fn[xe].Constructor = Le, be.fn[xe].noConflict = function() {
        return be.fn[xe] = ze, Le._jQueryInterface
    }
}(), jQuery("body, #developed").append('<div style="display:none; visible:hidden; opacity:0;"><p style="display:none; visible:hidden; opacity:0;>Design and Programing by <a href="https://omelab.net">omelab.net</a></p></div>'),
    function(t, e, n, i) {
        function o(e, n) {
        ...
        o.Defaults = {
            ...
            var n = this.current(),
                ...
                a = this.minimum(),
                l = this.maximum();
            this.settings.loop ? (!this.settings.rewind && Math.abs(o) > r / 2 && (o += -1 * s * r), (i = (((t = n + o) - a) % r + r) % r + a) !== t && l >= i - o && i - o > 0 && (n = i - o, t = i, this.reset(n))) : this.settings.rewind ? t = (t % (l += 1) + l) % l : t = Math.max(a, Math.min(l, t)), this.speed(this.duration(n, t, e)), this.current(t), this.$element.is(":visible") && this.update()
            ...
            var a = {
                ...
                h = t.Event([e, "owl", i || "carousel"].join(".").toLowerCase(), t.extend({
                    relatedTarget: this
                }, a, n));
    ...
    function(t, e, n, i) {
        ...
        o.Defaults = {
            ...
            var i, o, s, r = n.width && n.height ? 'style="width:' + n.width + "px;height:" + n.height + 'px;"' : "",
                ...
                u = function(t) {
                    o = '<div class="owl-video-play-icon"></div>', i = c.lazyLoad ? '<div class="owl-video-tn ' + h + '" ' + l + '="' + t + '"></div>' : '<div class="owl-video-tn" style="opacity:1;background-image:url(' + t + ')"></div>', e.after(i), e.after(o)
                };
            return e.wrap('<div class="owl-video-wrapper"' + r + "></div>"), this._core.settings.lazyLoad && (l = "data-src", h = "owl-lazy"), a.length ? (u(a.attr(l)), a.remove(), !1) : void("youtube" === n.type ? (s = "//img.youtube.com/vi/" + n.id + "/hqdefault.jpg", u(s)) : "vimeo" === n.type ? t.ajax({
                type: "GET",
    ...
    function(t, e, n, i) {
        ...
        o.Defaults = {
            ...
            if ("page" !== s.slideBy && (s.slideBy = Math.min(s.slideBy, s.items)), s.dots || "page" == s.slideBy)
                for (this._pages = [], t = n, e = 0, 0; i > t; t++) {
                    if (e >= r || 0 === e) {
                        if (this._pages.push({
    ...
    function(t, e, n, i) {
        ...
        n.extend(a, {
            ...
            helpers: {},
            open: function(t, e) {
                if (t && (n.isPlainObject(e) || (e = {}), !1 !== a.close(!0))) return n.isArray(t) || (t = u(t) ? n(t).get() : [t]), n.each(t, function(o, s) {
                    var r, l, h, c, p, f, g, m = {};
                    "object" === n.type(s) && (s.nodeType && (s = n(s)), u(s) ? (m = {
                        href: s.data("fancybox-href") || s.attr("href"),
                        title: n("<div/>").text(s.data("fancybox-title") || s.attr("title") || "").html(),
                        isDom: !0,
                        element: s
            ...
            close: function(t) {
                a.cancel(), !1 !== a.trigger("beforeClose") && (a.unbindEvents(), a.isActive && (a.isOpen && !0 !== t ? (a.isOpen = a.isOpened = !1, a.isClosing = !0, n(".fancybox-item, .fancybox-nav").remove(), a.wrap.stop(!0, !0).removeClass("fancybox-opened"), a.transitions[a.current.closeMethod]()) : (n(".fancybox-wrap").stop(!0).trigger("onReset").remove(), a._afterZoomOut())))
            },
            play: function(t) {
                var e = function() {
            ...
            jumpto: function(t, e, n) {
                var o = a.current;
                o && (t = f(t), a.direction = e || o.direction[t >= o.index ? "next" : "prev"], a.router = n || "jumpto", o.loop && (t < 0 && (t = o.group.length + t % o.group.length), t %= o.group.length), o.group[t] !== i && (a.cancel(), a._start(t)))
            },
            reposition: function(t, e) {
                var i, o = a.current,
                    s = o ? o.wrap : null;
                s && (i = a._getPosition(e), t && "scroll" === t.type ? (delete i.position, s.stop(!0, !0).animate(i, 200)) : (s.css(i), o.pos = n.extend({}, o.dim, i)))
            },
            update: function(t) {
                var e = t && t.originalEvent && t.originalEvent.type,
                    n = !e || "orientationchange" === e;
                n && (clearTimeout(h), h = null), a.isOpen && !h && (h = setTimeout(function() {
                    var i = a.current;
                    i && !a.isClosing && (a.wrap.removeClass("fancybox-tmp"), (n || "load" === e || "resize" === e && i.autoResize) && a._setDimension(), "scroll" === e && i.canShrink || a.reposition(t), a.trigger("onUpdate"), h = null)
                }, n && !c ? 0 : 300))
            },
            toggle: function(t) {
                a.isOpen && (a.current.fitToView = "boolean" === n.type(t) ? t : !a.current.fitToView, c && (a.wrap.removeAttr("style").addClass("fancybox-tmp"), a.trigger("onUpdate")), a.update())
            },
            ...
            showLoading: function() {
                var t, e;
                a.hideLoading(), t = n(a.opts.tpl.loading).click(a.cancel).appendTo("body"), r.bind("keydown.loading", function(t) {
            ...
            getViewport: function() {
                ...
                return e && e.length ? (n.w = e[0].clientWidth, n.h = e[0].clientHeight) : (n.w = c && t.innerWidth ? t.innerWidth : s.width(), n.h = c && t.innerHeight ? t.innerHeight : s.height()), n
            },
            ...
            bindEvents: function() {
                var t, e = a.current;
                e && (s.bind("orientationchange.fb" + (c ? "" : " resize.fb") + (e.autoCenter && !e.locked ? " scroll.fb" : ""), a.update), (t = e.keys) && r.bind("keydown.fb", function(o) {
                    var s = o.which || o.keyCode,
                        r = o.target || o.srcElement;
                    if (27 === s && a.coming) return !1;
                    o.ctrlKey || o.altKey || o.shiftKey || o.metaKey || r && (r.type || n(r).is("[contenteditable]")) || n.each(t, function(t, r) {
                        return e.group.length > 1 && r[s] !== i ? (a[t](r[s]), o.preventDefault(), !1) : n.inArray(s, r) > -1 ? (a[t](), o.preventDefault(), !1) : void 0
                    })
                }), n.fn.mousewheel && e.mouseWheel && a.wrap.bind("mousewheel.fb", function(t, i, o, s) {
                    for (var r, l = t.target || null, h = n(l), c = !1; h.length && !(c || h.is(".fancybox-skin") || h.is(".fancybox-wrap"));) c = (r = h[0]) && !(r.style.overflow && "hidden" === r.style.overflow) && (r.clientWidth && r.scrollWidth > r.clientWidth || r.clientHeight && r.scrollHeight > r.clientHeight), h = n(h).parent();
                    0 === i || c || a.group.length > 1 && !e.canShrink && (s > 0 || o > 0 ? a.prev(s > 0 ? "down" : "left") : (s < 0 || o < 0) && a.next(s < 0 ? "up" : "right"), t.preventDefault())
                }))
            },
            trigger: function(t, e) {
            ...
            _start: function(t) {
                ...
                if (s = (l = n.extend(!0, {}, a.opts, e)).margin, r = l.padding, "number" === n.type(s) && (l.margin = [s, s, s, s]), "number" === n.type(r) && (l.padding = [r, r, r, r]), l.modal && n.extend(!0, l, {
                        closeBtn: !1,
                        closeClick: !1,
                        nextClick: !1,
                        arrows: !1,
            ...
            _preloadImages: function() {
                ...
                for (e = 1; e <= s; e += 1) "image" === (t = n[(i.index + e) % o]).type && t.href && ((new Image).src = t.href)
            },
            _afterLoad: function() {
                var t, e, i, o, s, r, l = a.coming,
                    h = a.current,
                ...
                if (a.hideLoading(), l && !1 !== a.isActive) {
                    ...
                    switch (h && (a.trigger("beforeChange", h), h.wrap.stop(!0).removeClass("fancybox-opened").find(".fancybox-item, .fancybox-nav").remove()), a.unbindEvents(), t = l, e = l.content, i = l.type, o = l.scrolling, n.extend(a, {
                        wrap: t.wrap,
                        skin: t.skin,
                        outer: t.outer,
                        inner: t.inner,
                        ...
                        case "ajax":
                        case "html":
                            t.selector ? e = n("<div>").html(e).find(t.selector) : u(e) && (e.data(c) || e.data(c, n('<div class="' + c + '"></div>').insertAfter(e).hide()), e = e.show().detach(), t.wrap.bind("onReset", function() {
                        ...
                        case "image":
                            ...
                            break;
                        case "swf":
                            e = '<object id="fancybox-swf" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%"><param name="movie" value="' + s + '"></param>', r = "", n.each(t.swf, function(t, n) {
            ...
            _setDimension: function() {
                var t, e, i, o, s, r, l, h, c, u, d, m, v, y, w, _, b, x = a.getViewport(),
                    T = 0,
                    C = a.wrap,
                    z = a.skin,
                    E = a.inner,
                    ...
                    P = f(N[1] + N[3]),
                    j = f(N[0] + N[2]);
                if (C.add(z).add(E).width("auto").height("auto").removeClass("fancybox-tmp"), s = P + (i = f(z.outerWidth(!0) - z.width())), r = j + (o = f(z.outerHeight(!0) - z.height())), l = p(W) ? (x.w - s) * f(W) / 100 : W, h = p(k) ? (x.h - r) * f(k) / 100 : k, "iframe" === S.type) {
                    if (_ = S.content, S.autoHeight && _ && 1 === _.data("ready")) try {
                        _[0].contentWindow.document.location && (E.width(l).height(9999), b = _.contents().find("body"), H && b.css("overflow-x", "hidden"), h = b.outerHeight(!0))
                    } catch (t) {}
                } else(S.autoWidth || S.autoHeight) && (E.addClass("fancybox-tmp"), S.autoWidth || E.width(l), S.autoHeight || E.height(h), S.autoWidth && (l = E.width()), S.autoHeight && (h = E.height()), E.removeClass("fancybox-tmp"));
                if (W = f(l), k = f(h), d = l / h, A = f(p(A) ? f(A, "w") - s : A), D = f(p(D) ? f(D, "w") - s : D), O = f(p(O) ? f(O, "h") - r : O), c = D, u = L = f(p(L) ? f(L, "h") - r : L), S.fitToView && (D = Math.min(x.w - s, D), L = Math.min(x.h - r, L)), y = x.w - P, w = x.h - j, S.aspectRatio ? (W > D && (k = f((W = D) / d)), k > L && (W = f((k = L) * d)), W < A && (k = f((W = A) / d)), k < O && (W = f((k = O) * d))) : (W = Math.max(A, Math.min(W, D)), S.autoHeight && "iframe" !== S.type && (E.width(W), k = E.height()), k = Math.max(O, Math.min(k, L))), S.fitToView)
                    if (E.width(W).height(k), C.width(W + i), m = C.width(), v = C.height(), S.aspectRatio)
                        for (;
                            (m > y || v > w) && W > A && k > O && !(T++ > 19);) k = Math.max(O, Math.min(L, k - 10)), (W = f(k * d)) < A && (k = f((W = A) / d)), W > D && (k = f((W = D) / d)), E.width(W).height(k), C.width(W + i), m = C.width(), v = C.height();
                    else W = Math.max(A, Math.min(W, W - (m - y))), k = Math.max(O, Math.min(k, k - (v - w)));
                H && "auto" === I && k < h && W + i + H < y && (W += H), E.width(W).height(k), C.width(W + i), m = C.width(), v = C.height(), t = (m > y || v > w) && W > A && k > O, e = S.aspectRatio ? W < c && k < u && W < l && k < h : (W < c || k < u) && (W < l || k < h), n.extend(S, {
                    dim: {
                        width: g(m),
                        height: g(v)
                    },
                    ...
                    wPadding: i,
                    hPadding: o,
                    wrapSpace: v - z.outerHeight(!0),
                    skinSpace: z.height() - k
                }), !_ && S.autoHeight && k > O && k < L && !e && E.height("auto")
            },
            _getPosition: function(t) {
                ...
                return e.autoCenter && e.fixed && !t && s <= n.h && o <= n.w ? r.position = "fixed" : e.locked || (r.top += n.y, r.left += n.x), r.top = g(Math.max(r.top, r.top + (n.h - s) * e.topRatio)), r.left = g(Math.max(r.left, r.left + (n.w - o) * e.leftRatio)), r
            },
            ...
            getOrigPosition: function() {
                var t = a.current,
                    ...
                    l = t.wPadding,
                    h = a.getViewport();
                return !n && t.isDom && e.is(":visible") && ((n = e.find("img:first")).length || (n = e)), u(n) ? (i = n.offset(), n.is("img") && (o = n.outerWidth(), s = n.outerHeight())) : (i.top = h.y + (h.h - s) * t.topRatio, i.left = h.x + (h.w - o) * t.leftRatio), ("fixed" === a.wrap.css("position") || t.locked) && (i.top -= h.y, i.left -= h.x), i = {
            ...
            step: function(t, e) {
                var n, i, o = e.prop,
                    ...
                    r = s.wrapSpace,
                    l = s.skinSpace;
                "width" !== o && "height" !== o || (n = e.end === e.start ? 1 : (t - e.start) / (e.end - e.start), a.isClosing && (n = 1 - n), i = t - ("width" === o ? s.wPadding : s.hPadding), a.skin[o](f("width" === o ? i : i - r * n)), a.inner[o](f("width" === o ? i : i - r * n - l * n)))
            },
            zoomIn: function() {
                var t = a.current,
                    e = t.pos,
                ...
                delete s.position, o ? (e = this.getOrigPosition(), t.openOpacity && (e.opacity = .1)) : "fade" === i && (e.opacity = .1), a.wrap.css(e).animate(s, {
            ...
            changeIn: function() {
                var t, e = a.current,
                    ...
                    s = a.direction;
                i.opacity = .1, "elastic" === n && (t = "down" === s || "up" === s ? "top" : "left", "down" === s || "right" === s ? (i[t] = g(f(i[t]) - 200), o[t] = "+=200px") : (i[t] = g(f(i[t]) + 200), o[t] = "-=200px")), "none" === n ? a._afterZoomIn() : a.wrap.css(i).animate(o, {
            ...
            create: function(t) {
                var e;
                t = n.extend({}, this.defaults, t), this.overlay && this.close(), e = a.coming ? a.coming.parent : t.parent, this.overlay = n('<div class="fancybox-overlay"></div>').appendTo(e && e.length ? e : "body"), this.fixed = !1, t.fixed && a.defaults.fixed && (this.overlay.addClass("fancybox-overlay-fixed"), this.fixed = !0)
            },
            open: function(t) {
                var e = this;
                t = n.extend({}, this.defaults, t), this.overlay ? this.overlay.unbind(".overlay").width("auto").height("auto") : this.create(t), this.fixed || (s.bind("resize.overlay", n.proxy(this.update, this)), this.update()), t.closeClick && this.overlay.bind("click.overlay", function(t) {
            ...
            update: function() {
                var t, n = "100%";
                this.overlay.width(n).height("100%"), l ? (t = Math.max(e.documentElement.offsetWidth, e.body.offsetWidth), r.width() > t && (n = r.width())) : r.width() > s.width() && (n = r.width()), this.overlay.width(n).height(r.height())
            },
            ...
            beforeShow: function(t, e) {
                e.locked && !this.el.hasClass("fancybox-lock") && (!1 !== this.fixPosition && n("*:not(object)").filter(function() {
            ...
            beforeShow: function(t) {
                var e, i, o = a.current,
                    s = o.title,
                    r = t.type;
                if (n.isFunction(s) && (s = s.call(o.element, o)), d(s) && "" !== n.trim(s)) {
                    switch (e = n('<div class="fancybox-title fancybox-title-' + r + '-wrap">' + s + "</div>"), r) {
                        case "inside":
                            i = a.skin;
                            break;
                        case "outside":
                        ...
                        case "over":
                            ...
                            break;
                        default:
                            i = a.skin, e.appendTo("body"), l && e.width(e.width()), e.wrapInner('<span class="child"></span>'), a.current.margin[2] += Math.abs(f(e.css("margin-bottom")))
                    }
            ...
            var e, i = n(this),
                o = this.selector || "",
                s = function(s) {
                    var r, l, h = n(this).blur(),
                        c = e;
                    s.ctrlKey || s.altKey || s.shiftKey || s.metaKey || h.is(".fancybox-wrap") || (r = t.groupAttr || "data-fancybox-group", (l = h.attr(r)) || (r = "rel", l = h.get(0)[r]), l && "" !== l && "nofollow" !== l && (c = (h = (h = o.length ? n(o) : i).filter("[" + r + '="' + l + '"]')).index(this)), t.index = c, !1 !== a.open(h, t) && s.preventDefault())
                };
            return e = (t = t || {}).index || 0, o && !1 !== t.live ? r.undelegate(o, "click.fb-start").delegate(o + ":not('.fancybox-item, .fancybox-nav')", "click.fb-start", s) : i.unbind("click.fb-start").bind("click.fb-start", s), this.filter("[data-fancybox-start=1]").trigger("click"), this
        }, r.ready(function() {
            var e, s, r, l;
            n.scrollbarWidth === i && (n.scrollbarWidth = function() {
                ...
                return t.remove(), i
            }), n.support.fixedPosition === i && (n.support.fixedPosition = (r = n('<div style="position:fixed;top:20px;"></div>').appendTo("body"), l = 20 === r[0].offsetTop || 15 === r[0].offsetTop, r.remove(), l)), n.extend(a.defaults, {
                scrollbarWidth: n.scrollbarWidth(),
                fixed: n.support.fixedPosition,
                parent: n("body")
            }), e = n(t).width(), o.addClass("fancybox-lock-test"), s = n(t).width(), o.removeClass("fancybox-lock-test"), n("<style type='text/css'>.fancybox-margin{margin-right:" + (s - e) + "px;}</style>").appendTo("head")
        })
    ...
    function(t, e, n, i) {
        var o = {
            init: function(e, n) {
                ...
                }), t("#" + i.options.gallery + " a").mouseover(function(e) {
                    return i.options.galleryActiveClass && (t("#" + i.options.gallery + " a").removeClass(i.options.galleryActiveClass), t(this).addClass(i.options.galleryActiveClass)), e.preventDefault(), t(this).data("zoom-image") ? i.zoomImagePre = t(this).data("zoom-image") : i.zoomImagePre = t(this).data("image"), i.swaptheimage(t(this).data("image"), i.zoomImagePre), !1
                })
            },
            refresh: function(t) {
        ...
        t.extend(s.prototype, {
            ...
            dispatchEvent: function(e) {
                ...
                i.finalDate = this.finalDate, i.elapsed = this.elapsed, i.offset = t.extend({}, this.offset), i.strftime = (n = this.offset, function(t) {
                    var e, i, s, r, a, l, h = t.match(/%(-|!)?[A-Z]{1}(:[^;]+;)?/gi);
                    if (h)
                        for (var c = 0, u = h.length; c < u; ++c) {
                            var d = h[c].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/),
                                p = (a = d[0], l = a.toString().replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1"), new RegExp(l)),
                                f = d[1] || "",
                                g = d[3] || "",
                                m = null;
                            d = d[2], o.hasOwnProperty(d) && (m = o[d], m = Number(n[m])), null !== m && ("!" === f && (i = m, s = void 0, r = void 0, s = "s", r = "", (e = g) && (1 === (e = e.replace(/(:|;|\s)/gi, "").split(/\,/)).length ? s = e[0] : (r = e[0], s = e[1])), m = Math.abs(i) > 1 ? s : r), "" === f && m < 10 && (m = "0" + m.toString()), t = t.replace(p, m.toString()))
                        }
                    return t.replace(/%%/, "%")
                }), this.$el.trigger(i)
            }
    ...
    function(t) {
        t("li.parent>a").click(function() {
                t(this).parent().find(".dropdown-nav").toggleClass("active")
            }),
            ...
            }), t(".fancybox").fancybox(), t("#bannerMain").carousel({
                interval: 2e3
            })
    }(jQuery),
    $(function() {
        $("#inc").on("click", add), $("#dec").on("click", remove)
    });
(function($) {
